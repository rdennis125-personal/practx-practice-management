...
namespace ServiceManager {
	public partial class FormServiceManage:Form {
		...
		private void RefreshFormData() {
			ServiceController service=ServicesHelper.GetServiceByServiceName(textName.Text);
			if(service!=null) {//installed
				...
				if(ServicesHelper.IsMySQLService(textPathToExe.Text)) {
					textPathToExe.Text=ServicesHelper.GetMySQLPathToExe(textPathToExe.Text);
				}
		...
		private void butUninstall_Click(object sender,EventArgs e) {
			if(_serviceFileInfo==null && !ServicesHelper.IsMySQLService(textPathToExe.Text)) {
