...
namespace UnitTests {
	public partial class FormToothChartTests : FormODBase {
		...
		private List<OrthoHardware> _listOrthoHardwares=new List<OrthoHardware>();
		...
		private void InitializeData() {
			...
			progressOD.ActionMain=() => {
				...
				_listToothInitials=ToothInitials.GetPatientData(_patient.PatNum);
				_listOrthoHardwares=OrthoHardwares.GetPatientData(_patient.PatNum);
				#endregion
		...
		private void butToothChartBig_Click(object sender,EventArgs e) {
			...
			#endregion
			FormToothChartingBig formToothChartingBig=new FormToothChartingBig(false);
			formToothChartingBig.ListToothInitials=_listToothInitials;
			formToothChartingBig.ListDataRowsProcs=_listRowsProcForGraphical;
			formToothChartingBig.ListOrthoHardwares=_listOrthoHardwares;
			formToothChartingBig.PatientCur=_patient.Copy();
