...
";*/
			...
			//textRich.Rtf="";
			textBox12.Select();//0,2);
			//bool worked=textBox12.Focus();
		...
		public void FillImageSelector(bool keepSelection) {
			...
			//List<Def> listDefsImageCats=new List<Def>();
			//for(int i=0;i<10;i++){
			//	Def def=new Def();
			//	def.DefNum=i+1;
			//	def.Category=DefCat.ImageCats;
			//	def.ItemName="Category "+i.ToString();
			//	listDefsImageCats.Add(def);
			//}
