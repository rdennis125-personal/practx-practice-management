	...
	public class WebForms_SheetsTests:TestBase {
		...
		public void WebForms_Sheets_ParseDateWebForms_AllCulturesWithManyDelimiters() {
			...
			List<string> listUnsupportedCultureNames=new List<string>() {
				"ar","ar-SA","fa","fa-AF","fa-IR","ku-Arab-IR","lrc","lrc-IR","mzn","mzn-IR","prs","prs-AF","ps","ps-AF","th","th-TH","uz-Arab","uz-Arab-AF" };
			foreach(CultureInfo culture in CultureInfo.GetCultures(CultureTypes.AllCultures)
				.Where(x => !listUnsupportedCultureNames.Contains(x.Name) && !string.IsNullOrWhiteSpace(x.Name)))
			{
