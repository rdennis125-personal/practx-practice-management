...
namespace UnitTests.DiscountPlanSubsTests {
	...
	public class DiscountPlanSubsTests:TestBase {
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRange1() {
			...
			bool isInRange=(refDate>=dateEffective && refDate<=dateTerm);
			DateTime dateEffectiveFinal=DiscountPlanSubs.GetDateEffectiveForAnnualDateRangeSegment(refDate,dateEffective,dateTerm);
			DateTime dateTermFinal=DiscountPlanSubs.GetDateTermForAnnualDateRangeSegment(refDate,dateEffective,dateTerm);
			...
			Assert.AreEqual(dateEffectiveFinal,new DateTime(DateTime.Now.Year,1,1));
			Assert.AreEqual(dateTermFinal,new DateTime(DateTime.Now.Year,12,31));
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRange4() {
			...
			Assert.AreEqual(true,buckets>index);
			Assert.AreEqual(isInRange,true);
			Assert.AreEqual(new DateTime(DateTime.Now.Year+1,1,1),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(DateTime.Now.Year+1,12,31),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsNotInRange1() {
			...
			Assert.AreEqual(new DateTime(DateTime.Now.Year,1,1),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(DateTime.Now.Year,12,31),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsNotInRange2() {
			...
			Assert.AreEqual(isInRange,false);
			Assert.AreEqual(new DateTime(DateTime.Now.Year,1,1),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(DateTime.Now.Year,12,30),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRangeLeapYear1() {
			...
			Assert.AreEqual(isInRange,true);
			Assert.AreEqual(1,buckets);
			Assert.AreEqual(new DateTime(2020,1,1),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(2020,12,31),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRangeLeapYear2() {
			...
			Assert.AreEqual(new DateTime(2021,2,28),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(2022,2,27),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRangeLeapYear3() {
			...
			Assert.AreEqual(isInRange,true);
			Assert.AreEqual(1,buckets);
			Assert.AreEqual(new DateTime(2020,2,29),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(2021,2,27),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRangeLeapYear7() {
			...
			Assert.AreEqual(new DateTime(2024,2,28),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(2025,2,27),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRangeLeapYear9() {
			...
			Assert.AreEqual(isInRange,true);
			Assert.AreEqual(1,buckets);
			Assert.AreEqual(new DateTime(2024,2,29),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(2025,2,27),dateTermFinal);
		}
		...
		public void DiscountPlanSubs_GetAnnualDateRangeSegmentForGivenDate_IsInRangeLeapYear10() {
			...
			Assert.AreEqual(isInRange,true);
			Assert.AreEqual(2,buckets);
			Assert.AreEqual(new DateTime(2025,2,28),dateEffectiveFinal);
			Assert.AreEqual(new DateTime(2026,2,27),dateTermFinal);
		}
