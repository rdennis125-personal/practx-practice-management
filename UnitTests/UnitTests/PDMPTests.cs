...
namespace UnitTests {
	...
	public class PDMPTests:TestBase {
		...
		private PdmpProperty CreateFakeProps() {
			long provNum=ProviderT.CreateProvider("Bamboo-doc",fName:"Paul",lName:"Doctor");
		...
		[TestMethod]
		public void PDMPBamboo_MakeRequester() {
			PdmpProperty props=CreateFakeProps();
			PDMPBamboo pdmp=new PDMPBamboo(props);
			pdmp.Url=props.Url;
		...
		[TestMethod]
		public void PDMPBamboo_MakePrescriptionRequest() {
			long provNum=ProviderT.CreateProvider("Bamboo-doc",fName:"Paul",lName:"Doctor");
			Provider prov=Providers.GetProv(provNum);
			prov.NationalProvID="1023011178";
			Patient pat=PatientT.CreatePatient(priProvNum:provNum,lName:"Married",fName:"Sherri",birthDate:new DateTime(1950,1,1));
		...
		[TestMethod]
		public void PDMPBamboo_GetResponse_HasScores() {
			PdmpProperty props=CreateFakeProps();
			BambooScript.ReportType mockReport=new BambooScript.ReportType();
			mockReport.Message="";//Messages are blank when a match is found
			BambooScript.NarxScoreType score1=new BambooScript.NarxScoreType();
			score1.ScoreType="Presc";
			score1.ScoreValue="100";
			BambooScript.NarxScoreType score2=new BambooScript.NarxScoreType();
			score1.ScoreType="Narco";
			score1.ScoreValue="200";
			mockReport.NarxScores=new BambooScript.NarxScoreType[] {score1,score2};
			PDMPBamboo pdmp=new PDMPBamboo(props);
		...
		[TestMethod]
		public void PDMPBamboo_GetResponse_NoScores() {
			PdmpProperty props=CreateFakeProps();
			PDMPBamboo pdmp=new PDMPBamboo(props);
			BambooScript.ReportType mockReport=new BambooScript.ReportType();
		...
		[TestMethod]
		public void PDMPBamboo_PasswordDigest() {
			string nonce="648db976-6428-459d-873e-891169e5a4e2";
			long epoch=1516658372;
			BambooAuth apps=new BambooAuth(epoch,nonce);
