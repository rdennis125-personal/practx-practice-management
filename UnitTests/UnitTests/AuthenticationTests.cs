...
namespace UnitTests.Authentication_Tests {
	...
	public class AuthenticationTests:TestBase {
		...
		public void Authentication_CheckUserodPassword() {
			...
			user.SetPassword(Authentication.GenerateLoginDetails("awesomePassword",HashTypes.SHA3_512));
			...
			string passhash=Authentication.HashPasswordSHA512("awesomePassword",user.GetPasswordContainer().Salt);
