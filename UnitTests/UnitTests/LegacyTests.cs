...
namespace UnitTests.Documentation{
	...
	public enum EnumTestNum{
		...
		PayPlanEdit_CreateTransferForDynamicPaymentPlans_PlanOverPaymentStaysWithCurrentFamilyMember=170,
		Procedures_ComputeEstimates_MultiVisitGroupProcedureSkipsSyncingClaimDateWhenInProcess=171,
		PayPlansDynamic_GetCompletedAmount_PayPlanLinksWithAmountOverride=172,
		ChartModules_GetProcDescriptPlanned_CompleteApptAttachedPlannedApptHasProcsAllPlannedApptProcsComplete=173,
		ChartModules_GetProcDescriptPlanned_CompleteApptAttachedPlannedApptHasProcsSomePlannedApptProcsComplete=174,
		ChartModules_GetProcDescriptPlanned_CompleteApptAttachedPlannedApptHasProcsNoPlannedApptProcsComplete=175,
		ChartModules_GetProcDescriptPlanned_CompleteApptAttachedPlannedApptHasNoProcs=176,
		GetChartModules_GetProcDescriptPlanned_UncompleteApptAttachedPlannedApptHasProcsAllPlannedApptProcsComplete=177,
		ChartModules_GetProcDescriptPlanned_UncompleteApptAttachedPlannedApptHasProcsSomePlannedApptProcsComplete=178,
		ChartModules_GetProcDescriptPlanned_UncompleteApptAttachedPlannedApptHasProcsNoPlannedApptProcsComplete=179,
		ChartModules_GetProcDescriptPlanned_UncompleteApptAttachedPlannedApptHasNoProcs=180,
		ChartModules_GetProcDescriptPlanned_NoApptAttachedPlannedApptHasProcsAllPlannedApptProcsComplete=181,
