...
namespace SlowQueryTool {
	partial class FormSlowQueryLog {
		...
		private void InitializeComponent() {
			...
			this.gridQueryGroups.CellDoubleClick += new SlowQueryLogTool.UI.ODGridClickEventHandler(this.gridQueryGroups_CellDoubleClick);
			this.gridQueryGroups.CellClick += new SlowQueryLogTool.UI.ODGridClickEventHandler(this.gridQueryGroups_CellClick);
			// 
			// gridQueries
			// 
		...
		private SlowQueryLogTool.UI.GridOD gridQueries;
		private SlowQueryLogTool.UI.GridOD gridQueryGroups;
