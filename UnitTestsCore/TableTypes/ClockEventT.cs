...
namespace UnitTestsCore {
	public class ClockEventT {
		...
		///<summary>Deletes everything from the ClockEvent table. Does not truncate the table so that PKs are not reused on accident.</summary>
		public static void ClearClockEventTable() {
