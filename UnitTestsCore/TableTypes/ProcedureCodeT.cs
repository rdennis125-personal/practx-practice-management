...
namespace UnitTestsCore {
	public class ProcedureCodeT {
		...
		///<summary>Updates the DateTStamp of a ProcedureCode to be the passed in date. DateTStamp is not normally editable.</summary>
		public static void UpdateDateTStamp(ProcedureCode procedureCode,DateTime date) {
			string command="UPDATE procedurecode SET DateTStamp="+POut.Date(date)
