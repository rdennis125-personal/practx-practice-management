...
namespace UnitTestsCore {
	public class PaymentT {
		...
		///<summary>Updates the DateEntry to match the PayDate of a Payment. Unable to set the DateEntry to anything but DateTime.Now in the CRUD Layer.</summary>
		public static void SetDateEntryEqualToPayDate(Payment payment) {
			string command="UPDATE payment SET DateEntry = "+POut.Date(payment.PayDate)
