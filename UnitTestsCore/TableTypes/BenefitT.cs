...
namespace UnitTestsCore {
	public class BenefitT {
		...
		public static Benefit CreateLimitation(long planNum,EbenefitCategory category,double amt){
			Benefit ben=new Benefit();
			ben.PlanNum=planNum;
			ben.BenefitType=InsBenefitType.Limitations;
			ben.CovCatNum=CovCats.GetForEbenCat(category).CovCatNum;
		...
		public static Benefit CreateForCategoryWithPatPlanNum(long patPlanNum,EbenefitCategory category,int percent) {
			Benefit ben=new Benefit();
			ben.PlanNum=0;
			ben.PatPlanNum=patPlanNum;
			ben.BenefitType=InsBenefitType.CoInsurance;
		...
		///<summary>Creates a benefit. Pass in either a planNum OR a patPlanNum. </summary>
		public static Benefit CreateBenefit(long planNum,long patPlanNum,long covCatNum=0,InsBenefitType insBenefitType=InsBenefitType.ActiveCoverage,
			int percent=0,double monetaryAmt=0,BenefitTimePeriod benefitTimePeriod=BenefitTimePeriod.None,BenefitQuantity benefitQuantityQualifier=BenefitQuantity.None,
			byte quantity=0,long codeNum=0,BenefitCoverageLevel benefitCoverageLevel=BenefitCoverageLevel.None,bool doInsert=true) 
		{
			Benefit benefit=new Benefit();
			benefit.PlanNum=planNum;
			...
			benefit.CovCatNum=covCatNum;
			benefit.BenefitType=insBenefitType;
