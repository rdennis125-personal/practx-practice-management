...
namespace UnitTestsCore {
	public class MedicationT {
		...
		public static Medication CreateMedication(string medName="",string rxCui="",bool isGeneric=false) {
			...
			long medNum=Medications.Insert(medication);
			if(isGeneric) {
				medication.GenericNum=medNum;
