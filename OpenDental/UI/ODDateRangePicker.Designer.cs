namespace OpenDental.UI {
	partial class ODDateRangePicker {
		...
		private void InitializeComponent() {
			...
			this.datePickerFrom.CalendarOpened += new System.EventHandler(this.datePickerFrom_CalendarOpened);
			this.datePickerFrom.CalendarClosed += new System.EventHandler(this.datePickerFrom_CalendarClosed);
			...
			this.datePickerTo.CalendarOpened += new System.EventHandler(this.datePickerTo_CalendarOpened);
			this.datePickerTo.CalendarClosed += new System.EventHandler(this.datePickerTo_CalendarClosed);
			this.datePickerTo.CalendarSelectionChanged += new System.EventHandler(this.datePickerTo_CalendarSelectionChanged);
			// 
			// ODDateRangePicker
			// 
