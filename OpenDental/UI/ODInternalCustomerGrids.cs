...
namespace OpenDental.UI {
	class ODInternalCustomerGrids : UserControl {
		private OpenDental.UI.TabControl tabHqBugControl;
		private OpenDental.UI.TabPage tabBugsFixed;
		private GridOD gridBugsFixed;
		private OpenDental.UI.TabPage tabBugSubs;
		...
		private OpenDental.UI.TabPage tabBugsInProgress;
		...
		private void InitializeComponent() {
			this.tabHqBugControl = new OpenDental.UI.TabControl();
			this.tabBugsInProgress = new OpenDental.UI.TabPage();
			this.gridBugsInProgress = new OpenDental.UI.GridOD();
			this.tabBugsFixed = new OpenDental.UI.TabPage();
			this.gridBugsFixed = new OpenDental.UI.GridOD();
			this.tabBugSubs = new OpenDental.UI.TabPage();
			...
			this.datePickerHqBugSub.CalendarClosed += new System.EventHandler(this.datePickerHqBugSub_CalendarClosed);
			// 
		...
		private void FillGrids(bool isRefreshNeeded=true) {
			...
			if(gridBugsFixed.Columns.Count==0) {
				gridBugsInProgress.Columns.Add(new GridColumn("Description",80){ IsWidthDynamic=true });
				gridBugsInProgress.Columns.Add(new GridColumn("Expert",55,HorizontalAlignment.Center));
				gridBugsInProgress.Columns.Add(new GridColumn("Has Job",55,HorizontalAlignment.Center));
				gridBugsFixed.Columns.Add(new GridColumn("Description",80){ IsWidthDynamic=true });
				gridBugsFixed.Columns.Add(new GridColumn("Vers.",55,HorizontalAlignment.Center));
				gridBugsFixed.Columns.Add(new GridColumn("Has Job",55,HorizontalAlignment.Center));
				gridBugSubmissions.Columns.Add(new GridColumn("Description",100){ IsWidthDynamic=true });
				gridBugSubmissions.Columns.Add(new GridColumn("Vers.",55,HorizontalAlignment.Center));
				gridBugSubmissions.Columns.Add(new GridColumn("Has Job",55,HorizontalAlignment.Center));
			}
			#endregion
			if(isRefreshNeeded) {
