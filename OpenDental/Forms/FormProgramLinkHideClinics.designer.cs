namespace OpenDental {
	partial class FormProgramLinkHideClinics {
		...
		private void InitializeComponent() {
			...
			this.listboxHiddenClinics = new OpenDental.UI.ListBox();
			this.listboxVisibleClinics = new OpenDental.UI.ListBox();
    ...
    "cs on the right.";
			...
			this.checkOrderAlphabetical.Location = new System.Drawing.Point(303, 55);
			this.checkOrderAlphabetical.Name = "checkOrderAlphabetical";
			this.checkOrderAlphabetical.Size = new System.Drawing.Size(136, 18);
		...
		private UI.ListBox listboxVisibleClinics;
