...
namespace OpenDental{
	partial class FormTsiHistory {
		...
		private void InitializeComponent() {
			...
			this.comboClientIDs = new OpenDental.UI.ComboBox();
			this.labelClientIDs = new System.Windows.Forms.Label();
			this.comboAcctStatuses = new OpenDental.UI.ComboBox();
			this.labelAccountStatuses = new System.Windows.Forms.Label();
			this.comboTransTypes = new OpenDental.UI.ComboBox();
			...
			this.groupRawMsg = new OpenDental.UI.GroupBox();
		...
		private UI.ComboBox comboTransTypes;
		private System.Windows.Forms.Label labelTransTypes;
		private UI.ComboBox comboAcctStatuses;
		...
		private OpenDental.UI.GroupBox groupRawMsg;
		private OpenDental.UI.CheckBox checkShowPatNums;
		...
		private UI.ComboBox comboClientIDs;
