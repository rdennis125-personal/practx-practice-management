namespace OpenDental {
	partial class FormEhrVaccinePatEdit {
		...
		private void InitializeComponent() {
			...
			this.listCompletionStatus = new OpenDental.UI.ListBox();
			this.label7 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.listAdministrationNote = new OpenDental.UI.ListBox();
			...
			this.listRefusalReason = new OpenDental.UI.ListBox();
			this.label14 = new System.Windows.Forms.Label();
			this.listAction = new OpenDental.UI.ListBox();
    ...
    "effect, intollerance, patient declines, specific disease, etc.";
		...
		private UI.ListBox listCompletionStatus;
		private System.Windows.Forms.Label label7;
		private System.Windows.Forms.Label label8;
		private UI.ListBox listAdministrationNote;
		...
		private UI.ListBox listRefusalReason;
		private System.Windows.Forms.Label label14;
		private UI.ListBox listAction;
