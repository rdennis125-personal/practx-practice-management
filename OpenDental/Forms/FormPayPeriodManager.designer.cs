...
namespace OpenDental {
	public partial class FormPayPeriodManager {
		...
		private void InitializeComponent()
		{
			...
			this.checkExcludeWeekends = new OpenDental.UI.CheckBox();
			...
			this.checkLast = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkExcludeWeekends;
		...
		private OpenDental.UI.CheckBox checkLast;
	}
}
