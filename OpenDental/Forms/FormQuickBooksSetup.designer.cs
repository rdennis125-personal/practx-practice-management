namespace OpenDental{
	partial class FormQuickBooksSetup {
		...
		private void InitializeComponent() {
			...
			this.listBoxClassRefsQB = new OpenDental.UI.ListBox();
			this.labelClass = new System.Windows.Forms.Label();
			this.butRemoveIncomeQB = new OpenDental.UI.Button();
			this.checkQuickBooksClassRefsEnabled = new OpenDental.UI.CheckBox();
			this.butAddIncomeQB = new OpenDental.UI.Button();
			this.listBoxIncomeAccountsQB = new OpenDental.UI.ListBox();
			...
			this.listBoxDepositAccountsQB = new OpenDental.UI.ListBox();
			...
			this.butSave.Location = new System.Drawing.Point(435, 603);
    ...
    "";
		...
		private OpenDental.UI.ListBox listBoxClassRefsQB;
		private System.Windows.Forms.Label labelClass;
		private UI.Button butRemoveIncomeQB;
		private OpenDental.UI.CheckBox checkQuickBooksClassRefsEnabled;
		private UI.Button butAddIncomeQB;
		private OpenDental.UI.ListBox listBoxIncomeAccountsQB;
		...
		private OpenDental.UI.ListBox listBoxDepositAccountsQB;
