namespace OpenDental {
	partial class FormEhrPatListElementEdit {
		...
		private void InitializeComponent() {
			...
			this.checkOrderBy = new OpenDental.UI.CheckBox();
			this.textLabValue = new System.Windows.Forms.TextBox();
			this.listRestriction = new OpenDental.UI.ListBox();
			this.listOperand = new OpenDental.UI.ListBox();
			...
			this.butSave.Location = new System.Drawing.Point(297, 236);
		...
		private OpenDental.UI.CheckBox checkOrderBy;
		private System.Windows.Forms.TextBox textLabValue;
		private OpenDental.UI.ListBox listRestriction;
		private OpenDental.UI.ListBox listOperand;
