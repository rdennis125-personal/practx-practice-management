namespace OpenDental{
	partial class FormTransworldSetup {
		...
		private void InitializeComponent() {
			...
			this.comboNegAdjType = new OpenDental.UI.ComboBox();
			this.comboPosAdjType = new OpenDental.UI.ComboBox();
			this.checkThankYouLetter = new OpenDental.UI.CheckBox();
			this.groupServicesEnabled = new OpenDental.UI.GroupBox();
			this.checkAccelService = new OpenDental.UI.CheckBox();
			this.checkPRService = new OpenDental.UI.CheckBox();
			this.checkCollService = new OpenDental.UI.CheckBox();
			this.groupSftpServerInfo = new OpenDental.UI.GroupBox();
			this.labelSftpPort = new System.Windows.Forms.Label();
			this.textSftpPort = new OpenDental.ValidNum();
			this.groupClientIDs = new OpenDental.UI.GroupBox();
			...
			this.groupSendActivity = new OpenDental.UI.GroupBox();
			this.labelPaidInFullBillType = new System.Windows.Forms.Label();
			this.comboPaidInFullBillType = new OpenDental.UI.ComboBox();
			this.numericSendFrequency = new System.Windows.Forms.NumericUpDown();
			this.comboSendFrequencyUnits = new OpenDental.UI.ComboBox();
			...
			this.butSave.Location = new System.Drawing.Point(337, 504);
    ...
    " and login credentials for that clinic.";
		...
		private OpenDental.UI.CheckBox checkThankYouLetter;
		...
		private OpenDental.UI.GroupBox groupSftpServerInfo;
		private OpenDental.UI.GroupBox groupClientIDs;
		...
		private OpenDental.UI.GroupBox groupSendActivity;
		private System.Windows.Forms.NumericUpDown numericSendFrequency;
		private OpenDental.UI.ComboBox comboSendFrequencyUnits;
		private System.Windows.Forms.Label labelSendFrequency;
		private OpenDental.UI.GroupBox groupServicesEnabled;
		private OpenDental.UI.CheckBox checkAccelService;
		private OpenDental.UI.CheckBox checkPRService;
		private OpenDental.UI.CheckBox checkCollService;
		private System.Windows.Forms.Label labelPaidInFullBillType;
		private UI.ComboBox comboPaidInFullBillType;
		private UI.ComboBox comboNegAdjType;
		private UI.ComboBox comboPosAdjType;
