namespace OpenDental{
	partial class FormEdgeExpressSetup {
		...
		private void InitializeComponent() {
			...
			this.checkWebPayEnabled = new OpenDental.UI.CheckBox();
			this.checkPrintReceipt = new OpenDental.UI.CheckBox();
			this.checkPromptSig = new OpenDental.UI.CheckBox();
			this.groupCredentials = new OpenDental.UI.GroupBox();
			...
			this.checkWebPayEnabled.Location = new System.Drawing.Point(68, 122);
			this.checkWebPayEnabled.Name = "checkWebPayEnabled";
			this.checkWebPayEnabled.Size = new System.Drawing.Size(302, 17);
		...
		private OpenDental.UI.CheckBox checkPromptSig;
		private OpenDental.UI.GroupBox groupCredentials;
		...
		private OpenDental.UI.CheckBox checkWebPayEnabled;
	}
}