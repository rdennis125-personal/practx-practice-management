namespace OpenDental{
	partial class FormBillingDefaults {
		...
		private void InitializeComponent() {
			...
			this.listModesToText = new OpenDental.UI.ListBox();
			...
			this.listElectBilling = new OpenDental.UI.ListBox();
			...
			this.checkMC = new OpenDental.UI.CheckBox();
			...
			this.butSave.Location = new System.Drawing.Point(798, 700);
			...
			this.listModesToText.Location = new System.Drawing.Point(642, 78);
			...
			this.textSmsTemplate.Location = new System.Drawing.Point(12, 64);
			...
			this.label7.Text = "These variables may be used in either box: [monthlyCardsOnFile], [nameF], [nameFnoPref], [nameFL], [nameFLnoPref], [namePref], [PatNum], [currentMonth], [MsgToPayURL], [StatementBalance], [StatementInsuranceEst], and [StatementURL].";
			// 
			// checkSinglePatient
			// 
			...
			// 
			// checkBillingEmailIncludeAutograph
			// 
			this.checkBillingEmailIncludeAutograph.Location = new System.Drawing.Point(12, 179);
			this.checkBillingEmailIncludeAutograph.Name = "checkBillingEmailIncludeAutograph";
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.groupBoxBilling.Controls.Add(this.checkIncludeClinicNum);
			...
			// 
			// checkIncludeClinicNum
			// 
			this.checkIncludeClinicNum.Location = new System.Drawing.Point(12, 113);
			this.checkIncludeClinicNum.Name = "checkIncludeClinicNum";
			this.checkIncludeClinicNum.Size = new System.Drawing.Size(270, 18);
			this.checkIncludeClinicNum.TabIndex = 265;
			this.checkIncludeClinicNum.Text = "Include Clinic Number";
			this.checkIncludeClinicNum.Visible = false;
			// 
			// checkIncludeAdjust
			// 
    ...
    "nstallment plan.";
		...
		private OpenDental.UI.CheckBox checkMC;
		...
		private OpenDental.UI.ListBox listElectBilling;
		...
		private OpenDental.UI.ListBox listModesToText;
