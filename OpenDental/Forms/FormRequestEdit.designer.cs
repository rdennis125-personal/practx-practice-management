namespace OpenDental{
	partial class FormRequestEdit {
		...
		private void InitializeComponent() {
			...
			this.checkIsMine = new OpenDental.UI.CheckBox();
			...
			this.groupMyVotes = new OpenDental.UI.GroupBox();
			this.textMyPointsRemain = new System.Windows.Forms.TextBox();
			this.label8 = new System.Windows.Forms.Label();
			this.checkIsCritical = new OpenDental.UI.CheckBox();
			...
			this.comboApproval = new OpenDental.UI.ComboBox();
    ...
    ".  Try to prepend your name to the note.";
			...
			this.butSave.Location = new System.Drawing.Point(796, 666);
		...
		private OpenDental.UI.CheckBox checkIsMine;
		...
		private OpenDental.UI.ComboBox comboApproval;
