namespace OpenDental {
	partial class FormPaySplitEdit {
		...
		private void InitializeComponent(){
			...
			this.listPatient = new OpenDental.UI.ListBox();
			this.labelAmount = new System.Windows.Forms.Label();
			this.checkPayPlan = new OpenDental.UI.CheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textPatient = new System.Windows.Forms.TextBox();
			this.checkPatOtherFam = new OpenDental.UI.CheckBox();
			...
			this.tabProcedure = new OpenDental.UI.TabPage();
			...
			this.tabAdjustment = new OpenDental.UI.TabPage();
    ...
    ".";
			...
			// tabProcedure
			// 
			this.tabProcedure.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			...
			this.tabProcedure.Location = new System.Drawing.Point(2, 21);
			this.tabProcedure.Name = "tabProcedure";
			this.tabProcedure.Padding = new System.Windows.Forms.Padding(3);
			this.tabProcedure.Size = new System.Drawing.Size(623, 203);
			...
			// tabAdjustment
			// 
			this.tabAdjustment.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			...
			this.tabAdjustment.Location = new System.Drawing.Point(2, 21);
			this.tabAdjustment.Name = "tabAdjustment";
			this.tabAdjustment.Padding = new System.Windows.Forms.Padding(3);
			this.tabAdjustment.Size = new System.Drawing.Size(623, 203);
		...
		private OpenDental.UI.CheckBox checkPatOtherFam;
		...
		private OpenDental.UI.ListBox listPatient;
		...
		private OpenDental.UI.TabPage tabProcedure;
		private OpenDental.UI.TabPage tabAdjustment;
