namespace OpenDental{
	partial class FormWebChatTools {
		...
		private void InitializeComponent() {
			...
			this.menuGridRight = new System.Windows.Forms.ContextMenu();
			this.menuItemAiChat = new System.Windows.Forms.MenuItem();
			...
			this.checkShowAi = new OpenDental.UI.CheckBox();
			this.butClearFilters = new OpenDental.UI.Button();
			this.comboSupervisors = new OpenDental.UI.ComboBox();
			...
			this.gridWebChatSessions.ContextMenu = this.menuGridRight;
			...
			// menuGridRight
			// 
			this.menuGridRight.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
            this.menuItemAiChat});
			// 
			// menuItemAiChat
			// 
			this.menuItemAiChat.Index = 0;
			this.menuItemAiChat.Text = "AI Chat";
			this.menuItemAiChat.Click += new System.EventHandler(this.menuItemAiChat_Click);
			// 
			...
			this.dateRangeWebChat.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.groupFilters.Controls.Add(this.checkShowAi);
			this.groupFilters.Controls.Add(this.butClearFilters);
			this.groupFilters.Controls.Add(this.comboSupervisors);
			this.groupFilters.Controls.Add(this.labelSupervisors);
			...
			// checkShowAi
			// 
			this.checkShowAi.Location = new System.Drawing.Point(814, 44);
			this.checkShowAi.Name = "checkShowAi";
			this.checkShowAi.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.checkShowAi.Size = new System.Drawing.Size(168, 21);
			this.checkShowAi.TabIndex = 18;
			this.checkShowAi.Text = "Show AI Sessions";
			// 
			// butClearFilters
			// 
			this.butClearFilters.Location = new System.Drawing.Point(1081, 31);
			this.butClearFilters.Name = "butClearFilters";
			this.butClearFilters.Size = new System.Drawing.Size(75, 24);
			this.butClearFilters.TabIndex = 17;
			this.butClearFilters.Text = "Clear Filters";
			...
			// comboSupervisors
			// 
			this.comboSupervisors.BackColor = System.Drawing.SystemColors.Window;
			this.comboSupervisors.Location = new System.Drawing.Point(814, 16);
			this.comboSupervisors.Name = "comboSupervisors";
			this.comboSupervisors.SelectionModeMulti = true;
			this.comboSupervisors.Size = new System.Drawing.Size(159, 21);
			this.comboSupervisors.TabIndex = 16;
			// 
			// labelSupervisors
			// 
			this.labelSupervisors.Location = new System.Drawing.Point(725, 16);
			this.labelSupervisors.Name = "labelSupervisors";
			this.labelSupervisors.Size = new System.Drawing.Size(83, 20);
			this.labelSupervisors.TabIndex = 15;
			this.labelSupervisors.Text = "Reports To";
			this.labelSupervisors.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// labelCount
			// 
		...
		private UI.ComboBox comboSupervisors;
		private System.Windows.Forms.Label labelSupervisors;
		private UI.Button butExport;
		private UI.Button butPrint;
		private UI.Button butClearFilters;
		private System.Windows.Forms.ContextMenu menuGridRight;
		private System.Windows.Forms.MenuItem menuItemAiChat;
		private UI.CheckBox checkShowAi;
	}
}