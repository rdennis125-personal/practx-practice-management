...
namespace OpenDental {
	public partial class FormGraphics {
		...
		private void InitializeComponent()
		{
			...
			this.checkHardwareAccel = new OpenDental.UI.CheckBox();
			this.checkDoubleBuffering = new OpenDental.UI.CheckBox();
			this.group3DToothChart = new OpenDental.UI.GroupBox();
			...
			this.checkAllFormats = new OpenDental.UI.CheckBox();
    ...
    "hen the 3D tooth chart is not working properly.";
			...
			this.butSave.Location = new System.Drawing.Point(786, 646);
    ...
    "driver issue";
		...
		private OpenDental.UI.CheckBox checkHardwareAccel;
		private OpenDental.UI.CheckBox checkDoubleBuffering;
		private OpenDental.UI.GroupBox group3DToothChart;
		private OpenDental.UI.GridOD gridFormats;
		private OpenDental.UI.CheckBox checkAllFormats;
