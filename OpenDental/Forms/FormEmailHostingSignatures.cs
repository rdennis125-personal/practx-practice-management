...
namespace OpenDental {
	public partial class FormEmailHostingSignatures:FormODBase {
		...
		private Clinic _clinicPrev;
		private bool _isAuthorized;

		private Clinic GetClinicSelected() {
		...
		private void FillSignature() {
			Clinic clinic=GetClinicSelected();
		...
		private void comboClinicMassEmail_SelectionChangeCommitted(object sender,EventArgs e) {
			if(GetClinicSelected().ClinicNum==_clinicPrev.ClinicNum) {//didn't change the selected clinic
				return;
			}
