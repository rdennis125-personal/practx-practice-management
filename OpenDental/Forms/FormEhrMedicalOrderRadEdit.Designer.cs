namespace OpenDental {
	partial class FormEhrMedicalOrderRadEdit {
		...
		private void InitializeComponent() {
			...
			this.checkIsDiscontinued = new OpenDental.UI.CheckBox();
			...
			this.butSave.Location = new System.Drawing.Point(403, 243);
		...
		private OpenDental.UI.CheckBox checkIsDiscontinued;
