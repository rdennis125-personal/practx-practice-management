namespace OpenDental{
	partial class FormReqFieldCondEdit {
		...
		private void InitializeComponent() {
			...
			this.listConditionType = new OpenDental.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textConditionValue1 = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.listConditionValues = new OpenDental.UI.ListBox();
			...
			this.listConditionValues.SelectionMode = OpenDental.UI.SelectionMode.MultiExtended;
			...
			this.butSave.Location = new System.Drawing.Point(318, 288);
