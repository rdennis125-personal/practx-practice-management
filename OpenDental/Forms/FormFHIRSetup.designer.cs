namespace OpenDental{
	partial class FormFHIRSetup {
		...
		private void InitializeComponent() {
			...
			this.listPermissions = new OpenDental.UI.ListBox();
			...
			this.butSave.Location = new System.Drawing.Point(694, 477);
			...
			this.label1.Text = "Default payment type for created payments";
		...
		private UI.ListBox listPermissions;
