namespace OpenDental{
	partial class FormReplicationSetup {
		...
		private void InitializeComponent() {
			...
			this.checkRandomPrimaryKeys = new OpenDental.UI.CheckBox();
			...
			this.groupBoxReplicationFailure = new OpenDental.UI.GroupBox();
			...
			this.checkRandomPrimaryKeys.Size = new System.Drawing.Size(527, 17);
    ...
    "ter.  The displayed values should fall within the range set above.";
		...
		private OpenDental.UI.GroupBox groupBoxReplicationFailure;
