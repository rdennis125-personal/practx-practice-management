namespace OpenDental{
	partial class FormSheetFieldSigBox {
		...
		private void InitializeComponent() {
			...
			this.checkAllowElectronicSig = new OpenDental.UI.CheckBox();
			this.checkRestrictSigProvider = new OpenDental.UI.CheckBox();
			this.SuspendLayout();
			// 
			// textUiLabelMobile
			// 
			this.textUiLabelMobile.Location = new System.Drawing.Point(181, 150);
			...
			// labelUiLabelMobile
			// 
			this.labelUiLabelMobile.Location = new System.Drawing.Point(76, 151);
			...
			// checkRequired
			// 
			this.checkRequired.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkRequired.Location = new System.Drawing.Point(126, 176);
			this.checkRequired.Name = "checkRequired";
			this.checkRequired.RightToLeft = System.Windows.Forms.RightToLeft.No;
			...
			this.butDelete.Location = new System.Drawing.Point(15, 261);
			...
			// textHeight
			// 
			this.textHeight.Location = new System.Drawing.Point(181, 124);
			...
			// label8
			// 
			this.label8.Location = new System.Drawing.Point(110, 125);
			...
			// textWidth
			// 
			this.textWidth.Location = new System.Drawing.Point(181, 98);
			...
			// textYPos
			// 
			this.textYPos.Location = new System.Drawing.Point(181, 72);
			...
			// label6
			// 
			this.label6.Location = new System.Drawing.Point(110, 73);
			...
			// textXPos
			// 
			this.textXPos.Location = new System.Drawing.Point(181, 46);
			...
			this.butSave.Location = new System.Drawing.Point(336, 261);
			...
			// textName
			// 
			this.textName.Location = new System.Drawing.Point(181, 20);
			...
			// labelName
			// 
			this.labelName.Location = new System.Drawing.Point(76, 21);
			...
			// 
			// checkAllowElectronicSig
			// 
			this.checkAllowElectronicSig.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkAllowElectronicSig.Location = new System.Drawing.Point(20, 199);
			this.checkAllowElectronicSig.Name = "checkAllowElectronicSig";
			this.checkAllowElectronicSig.Size = new System.Drawing.Size(175, 17);
			this.checkAllowElectronicSig.TabIndex = 306;
			this.checkAllowElectronicSig.Text = "Allow Electronic Signatures";
			// 
			// checkRestrictSigProvider
			// 
			this.checkRestrictSigProvider.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkRestrictSigProvider.Location = new System.Drawing.Point(1, 222);
			this.checkRestrictSigProvider.Name = "checkRestrictSigProvider";
			this.checkRestrictSigProvider.Size = new System.Drawing.Size(194, 17);
			this.checkRestrictSigProvider.TabIndex = 307;
			this.checkRestrictSigProvider.Text = "Restrict Signatures to Providers";
			// 
			// FormSheetFieldSigBox
			// 
			this.ClientSize = new System.Drawing.Size(423, 297);
			this.Controls.Add(this.checkRestrictSigProvider);
			this.Controls.Add(this.checkAllowElectronicSig);
		...
		private OpenDental.UI.CheckBox checkAllowElectronicSig;
		private OpenDental.UI.CheckBox checkRestrictSigProvider;
	}
}