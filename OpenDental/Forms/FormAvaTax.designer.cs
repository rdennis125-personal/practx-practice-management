namespace OpenDental{
	partial class FormAvaTax {
		...
		private void InitializeComponent() {
			...
			this.listBoxLogLevel = new OpenDental.UI.ListBox();
    ...
    "arated list.";
			...
			this.butSave.Location = new System.Drawing.Point(518, 645);
		...
		private UI.ListBox listBoxNonTaxedStates;
