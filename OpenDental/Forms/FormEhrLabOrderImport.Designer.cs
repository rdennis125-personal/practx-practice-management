namespace OpenDental {
	partial class FormEhrLabOrderImport {
		...
		private void InitializeComponent() {
			...
			this.listBoxRaces = new OpenDental.UI.ListBox();
			this.textGender = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.listBoxNames = new OpenDental.UI.ListBox();
		...
		private OpenDental.UI.ListBox listBoxNames;
		private System.Windows.Forms.Label label2;
		private OpenDental.UI.ListBox listBoxRaces;
