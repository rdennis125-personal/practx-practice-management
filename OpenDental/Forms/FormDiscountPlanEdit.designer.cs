namespace OpenDental{
	partial class FormDiscountPlanEdit {
		...
		private void InitializeComponent() {
			...
			this.comboBoxAdjType = new OpenDental.UI.ComboBox();
			...
			this.comboPatient = new OpenDental.UI.ComboBox();
		...
		private OpenDental.UI.ComboBox comboBoxAdjType;
		...
		private OpenDental.UI.ComboBox comboPatient;
