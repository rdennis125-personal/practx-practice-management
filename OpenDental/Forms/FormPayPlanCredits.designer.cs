namespace OpenDental {
	partial class FormPayPlanCredits {
		...
		private void InitializeComponent() {
			...
			this.checkHideUnattached = new OpenDental.UI.CheckBox();
			this.butPrint = new OpenDental.UI.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.checkShowImplicit = new OpenDental.UI.CheckBox();
    ...
    " Credits              ";
			...
			this.butSave.Location = new System.Drawing.Point(850, 477);
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FormPayPlanCredits_FormClosing);
		...
		private OpenDental.UI.CheckBox checkHideUnattached;
		private UI.Button butPrint;
		private System.Windows.Forms.Label label3;
		private OpenDental.UI.CheckBox checkShowImplicit;
	}
}