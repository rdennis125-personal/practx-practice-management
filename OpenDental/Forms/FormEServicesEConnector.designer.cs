namespace OpenDental{
	partial class FormEServicesEConnector {
		...
		private void InitializeComponent() {
			...
			this.checkEmailsWithDiffProcess = new OpenDental.UI.CheckBox();
			...
			// groupBox3
			// 
			this.groupBox3.Controls.Add(this.checkEnableEServicesListener);
    ...
    "h.";
			...
			this.butListenerServiceAck.Location = new System.Drawing.Point(908, 312);
    ...
    "ions when status is critical.";
			...
			this.gridListenerServiceStatusHistory.Size = new System.Drawing.Size(963, 165);
    ...
    "ill automatically resume when an active eConnector Service has been detected.";
		...
		private UI.CheckBox checkEnableEServicesListener;
	}
}