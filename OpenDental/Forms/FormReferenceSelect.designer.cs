namespace OpenDental{
	partial class FormReference {
		...
		private void InitializeComponent() {
			...
			this.checkBadRefs = new OpenDental.UI.CheckBox();
			this.groupFilter = new OpenDental.UI.GroupBox();
			this.listBillingType = new OpenDental.UI.ListBox();
			this.label10 = new System.Windows.Forms.Label();
			this.checkUsedRefs = new OpenDental.UI.CheckBox();
			this.checkGuarOnly = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkBadRefs;
		...
		private OpenDental.UI.CheckBox checkUsedRefs;
		...
		private OpenDental.UI.CheckBox checkGuarOnly;
