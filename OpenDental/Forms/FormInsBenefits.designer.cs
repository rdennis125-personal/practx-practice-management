...
namespace OpenDental {
	public partial class FormInsBenefits {
		...
		private void InitializeComponent()
		{
			...
			this.gridAgeLimits = new OpenDental.UI.GridOD();
			...
			// panelSimple
			// 
			this.panelSimple.Controls.Add(this.gridAgeLimits);
			...
			// gridAgeLimits
			// 
			this.gridAgeLimits.Location = new System.Drawing.Point(6, 66);
			this.gridAgeLimits.Name = "gridAgeLimits";
			this.gridAgeLimits.SelectionMode = OpenDental.UI.GridSelectionMode.OneCell;
			this.gridAgeLimits.Size = new System.Drawing.Size(268, 138);
			this.gridAgeLimits.TabIndex = 164;
			this.gridAgeLimits.Title = "Age Limits";
			this.gridAgeLimits.TranslationName = "TableAgeLimits";
			// 
			// label14
			// 
			...
			this.gridFrequencies.TranslationName = "TableFreqLimitations";
    ...
    "rt.\n5 lines in 72 vert\n6 lines in 85 vert\n7 lines in 98";
		...
		private UI.GridOD gridAgeLimits;
	}
}
