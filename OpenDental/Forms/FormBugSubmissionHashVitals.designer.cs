namespace OpenDental {
	partial class FormBugSubmissionHashVitals {
		...
		private void InitializeComponent() {
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.splitContainer.Location = new System.Drawing.Point(12, 346);
			this.splitContainer.Name = "splitContainer";
			this.splitContainer.Orientation = System.Windows.Forms.Orientation.Horizontal;
			// 
			// splitContainer.Panel1
			// 
			this.splitContainer.Panel1.Controls.Add(this.gridSubs);
			// 
			// splitContainer.Panel2
			// 
			this.splitContainer.Panel2.Controls.Add(this.groupBox2);
			this.splitContainer.Panel2.Controls.Add(this.chartVitals);
			this.splitContainer.Size = new System.Drawing.Size(1127, 484);
