namespace OpenDental{
	partial class FormWebSchedCarrierRule {
		...
		private void InitializeComponent() {
			...
			this.checkNewPatRequestIns = new OpenDental.UI.CheckBox();
			this.checkExistingPatRequestIns = new OpenDental.UI.CheckBox();
    ...
    "nline appointments. Rules can be set up to allow or block specific carriers.";
		...
		private OpenDental.UI.CheckBox checkNewPatRequestIns;
		private OpenDental.UI.CheckBox checkExistingPatRequestIns;
