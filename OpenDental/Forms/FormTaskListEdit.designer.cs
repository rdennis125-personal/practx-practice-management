...
namespace OpenDental {
	public partial class FormTaskListEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listDateType = new OpenDental.UI.ListBox();
			...
			// checkFromNum
			// 
			this.checkFromNum.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
		...
		private OpenDental.UI.ListBox listDateType;
