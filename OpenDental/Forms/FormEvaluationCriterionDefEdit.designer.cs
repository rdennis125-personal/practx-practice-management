namespace OpenDental{
	partial class FormEvaluationCriterionDefEdit {
		...
		private void InitializeComponent() {
			...
			this.checkIsCategoryName = new OpenDental.UI.CheckBox();
			...
			this.butSave.Location = new System.Drawing.Point(273, 138);
		...
		private OpenDental.UI.CheckBox checkIsCategoryName;
