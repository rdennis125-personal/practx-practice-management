...
namespace OpenDental {
	public partial class FormTimeCardSetup {
		...
		private void InitializeComponent() {
			...
			this.checkHideOlder = new OpenDental.UI.CheckBox();
			...
			this.gridRules.HasAutoWrappedHeaders = true;
			this.gridRules.HasMultilineHeaders = true;
		...
		private OpenDental.UI.CheckBox checkShowSeconds;
		private UI.Button butGenerate;
		private UI.Button butDelete;
		private OpenDental.UI.CheckBox checkHideOlder;
