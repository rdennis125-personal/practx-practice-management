namespace OpenDental{
	partial class FormHL7DefEdit {
		...
		private void InitializeComponent() {
			...
			this.checkInternal = new OpenDental.UI.CheckBox();
			...
			this.checkShowAccount = new OpenDental.UI.CheckBox();
			...
			this.checkLongDCodes = new OpenDental.UI.CheckBox();
			this.checkProcsAppt = new OpenDental.UI.CheckBox();
    ...
    "messages.";
			...
			this.butSave.Location = new System.Drawing.Point(738, 660);
			this.butSave.Name = "butSave";
			this.butSave.Size = new System.Drawing.Size(75, 24);
			this.butSave.TabIndex = 69;
		...
		private OpenDental.UI.CheckBox checkInternal;
		...
		private OpenDental.UI.CheckBox checkShowAccount;
		private OpenDental.UI.CheckBox checkShowAppts;
