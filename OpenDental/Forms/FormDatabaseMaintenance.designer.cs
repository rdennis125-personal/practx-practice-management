...
namespace OpenDental {
	public partial class FormDatabaseMaintenance {
		...
		private void InitializeComponent() {
			...
			this.butExplainChecks = new OpenDental.UI.Button();
			this.butStopDBM = new OpenDental.UI.Button();
			this.tabHidden = new OpenDental.UI.TabPage();
			this.butExplainHidden = new OpenDental.UI.Button();
			...
			this.butExplainOld = new OpenDental.UI.Button();
			...
			this.textChecks.Size = new System.Drawing.Size(779, 59);
			this.textChecks.TabIndex = 1;
			this.textChecks.TabStop = false;
			this.textChecks.Text = resources.GetString("textChecks.Text");
			// 
			// butCheck
			// 
			...
			this.butCheck.Location = new System.Drawing.Point(305, 573);
			...
			this.checkShow.Location = new System.Drawing.Point(6, 518);
			...
			this.butPrint.Location = new System.Drawing.Point(6, 573);
			...
			this.butFix.Location = new System.Drawing.Point(430, 573);
			...
			this.gridMain.Location = new System.Drawing.Point(6, 71);
			this.gridMain.Name = "gridMain";
			this.gridMain.SelectionMode = OpenDental.UI.GridSelectionMode.MultiExtended;
			this.gridMain.Size = new System.Drawing.Size(794, 441);
			...
			this.butNoneChecks.Location = new System.Drawing.Point(725, 518);
			...
			this.textNoneChecks.Location = new System.Drawing.Point(354, 518);
    ...
    "thods will run.";
			...
			this.tabControlDBM.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			...
			this.tabChecks.Controls.Add(this.butExplainChecks);
			...
			this.tabChecks.Location = new System.Drawing.Point(2, 21);
			this.tabChecks.Name = "tabChecks";
			this.tabChecks.Padding = new System.Windows.Forms.Padding(3);
			this.tabChecks.Size = new System.Drawing.Size(806, 614);
			this.tabChecks.TabIndex = 0;
			this.tabChecks.Text = "Checks";
			// 
			// butExplainChecks
			// 
			this.butExplainChecks.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.butExplainChecks.Location = new System.Drawing.Point(660, 573);
			this.butExplainChecks.Name = "butExplainChecks";
			this.butExplainChecks.Size = new System.Drawing.Size(75, 24);
			this.butExplainChecks.TabIndex = 102;
			this.butExplainChecks.Text = "&Explain";
			this.butExplainChecks.Click += new System.EventHandler(this.butExplain_Click);
			// 
			// butStopDBM
			// 
			...
			this.butStopDBM.Location = new System.Drawing.Point(549, 573);
			...
			this.tabHidden.Controls.Add(this.butExplainHidden);
			...
			this.tabHidden.Location = new System.Drawing.Point(2, 21);
			this.tabHidden.Name = "tabHidden";
			this.tabHidden.Padding = new System.Windows.Forms.Padding(3);
			this.tabHidden.Size = new System.Drawing.Size(806, 614);
			this.tabHidden.TabIndex = 2;
			this.tabHidden.Text = "Hidden";
			// 
			// butExplainHidden
			// 
			this.butExplainHidden.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.butExplainHidden.Location = new System.Drawing.Point(662, 554);
			this.butExplainHidden.Name = "butExplainHidden";
			this.butExplainHidden.Size = new System.Drawing.Size(75, 24);
			this.butExplainHidden.TabIndex = 103;
			this.butExplainHidden.Text = "&Explain";
			this.butExplainHidden.Click += new System.EventHandler(this.butExplain_Click);
			// 
			// butSelectAll
			// 
			...
			this.butSelectAll.Location = new System.Drawing.Point(725, 499);
    ...
    " method by selecting a method, right clicking, and select Unhide.\r\n\r\n";
			...
			this.gridHidden.Size = new System.Drawing.Size(794, 441);
			...
			this.tabOld.Controls.Add(this.butExplainOld);
			...
			this.tabOld.Location = new System.Drawing.Point(2, 21);
			this.tabOld.Name = "tabOld";
			this.tabOld.Padding = new System.Windows.Forms.Padding(3);
			this.tabOld.Size = new System.Drawing.Size(806, 614);
			this.tabOld.TabIndex = 3;
			this.tabOld.Text = "Old";
			// 
			// butExplainOld
			// 
			this.butExplainOld.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.butExplainOld.Location = new System.Drawing.Point(662, 554);
			this.butExplainOld.Name = "butExplainOld";
			this.butExplainOld.Size = new System.Drawing.Size(75, 24);
			this.butExplainOld.TabIndex = 104;
			this.butExplainOld.Text = "&Explain";
			this.butExplainOld.Click += new System.EventHandler(this.butExplain_Click);
			// 
			// checkShowHidden
			// 
			...
			this.checkShowHidden.Location = new System.Drawing.Point(6, 566);
			...
			this.butStopDBMOld.Location = new System.Drawing.Point(549, 554);
			...
			this.textNoneOld.Location = new System.Drawing.Point(354, 499);
    ...
    "cks will run.\r\n";
			...
			this.butNoneOld.Location = new System.Drawing.Point(725, 499);
			...
			this.butFixOld.Location = new System.Drawing.Point(427, 554);
			...
			this.butCheckOld.Location = new System.Drawing.Point(302, 554);
    ...
    "essary. Should not be ran unless directly told to do so.\r\n\r\n";
			...
			this.gridOld.Size = new System.Drawing.Size(794, 441);
			...
			this.tabTools.Location = new System.Drawing.Point(2, 21);
			this.tabTools.Name = "tabTools";
			this.tabTools.Padding = new System.Windows.Forms.Padding(3);
			this.tabTools.Size = new System.Drawing.Size(806, 614);
			...
			this.butFixTools.Location = new System.Drawing.Point(725, 582);
    ...
    "s and you are sure an update is not currently in progress.";
		...
		private UI.Button butExplainChecks;
		private UI.Button butExplainHidden;
		private UI.Button butExplainOld;
	}
}
