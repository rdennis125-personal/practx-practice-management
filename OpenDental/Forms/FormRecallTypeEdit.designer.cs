...
namespace OpenDental {
	public partial class FormRecallTypeEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listTriggers = new OpenDental.UI.ListBox();
			...
			this.checkAppendToSpecial = new OpenDental.UI.CheckBox();
    ...
    "pe.";
		...
		private OpenDental.UI.ListBox listTriggers;
		...
		private OpenDental.UI.CheckBox checkAppendToSpecial;
