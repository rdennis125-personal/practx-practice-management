...
namespace OpenDental {
	public partial class FormMassEmailTemplates:FormODBase {
		...
		private void SelectAndLoadFirstTemplate() {
			...
			userControlEmailTemplate.RefreshView(emailHostingTemplateSelected.BodyPlainText,emailHostingTemplateSelected.BodyHTML,emailHostingTemplateSelected.EmailTemplateType);
		}
		...
		private void butCopy_Click(object sender,EventArgs e) {
			...
			FillGrid();
			emailHostingTemplateCopy=_listEmailHostingTemplates.FirstOrDefault(x => x.EmailHostingTemplateNum==formMassEmailTemplate.NewTemplateCurPriKey);
			if(emailHostingTemplateCopy!=null) {
				gridMain.SetSelected(_listEmailHostingTemplates.IndexOf(emailHostingTemplateCopy),true);
				userControlEmailTemplate.RefreshView(emailHostingTemplateCopy.BodyPlainText,emailHostingTemplateCopy.BodyHTML,emailHostingTemplateCopy.EmailTemplateType);
				return;
			}
			SelectAndLoadFirstTemplate();
		}
