...
namespace OpenDental {
	public partial class FormMessagingButSetup {
		...
		private void InitializeComponent()
		{
			...
			this.listButtons = new OpenDental.UI.ListBox();
			this.listComputers = new OpenDental.UI.ListBox();
		...
		private OpenDental.UI.ListBox listButtons;
		private OpenDental.UI.ListBox listComputers;
		private Label label2;
		private UI.Button butSynchAll;
	}
}
