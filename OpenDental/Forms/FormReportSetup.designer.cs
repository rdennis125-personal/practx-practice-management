namespace OpenDental{
	partial class FormReportSetup {
		...
		private void InitializeComponent() {
			...
			this.tabDisplaySettings = new OpenDental.UI.TabPage();
			...
			this.tabMiscOptions = new OpenDental.UI.TabPage();
			this.checkUserQueryDefaultRaw = new OpenDental.UI.CheckBox();
			...
			this.checkOutstandingRpDateTab = new OpenDental.UI.CheckBox();
			this.checkBenefitAssumeGeneral = new OpenDental.UI.CheckBox();
			this.checkReportsIncompleteProcsUnsigned = new OpenDental.UI.CheckBox();
			this.checkReportsIncompleteProcsNoNotes = new OpenDental.UI.CheckBox();
			this.checkNetProdDetailUseSnapshotToday = new OpenDental.UI.CheckBox();
			this.checkProviderPayrollAllowToday = new OpenDental.UI.CheckBox();
			this.checkReportsShowHistory = new OpenDental.UI.CheckBox();
			this.checkReportProdWO = new OpenDental.UI.CheckBox();
			this.checkReportPIClinic = new OpenDental.UI.CheckBox();
			this.checkReportsShowPatNum = new OpenDental.UI.CheckBox();
			...
			this.tabDisplaySettings.Location = new System.Drawing.Point(2, 21);
			this.tabDisplaySettings.Name = "tabDisplaySettings";
			this.tabDisplaySettings.Padding = new System.Windows.Forms.Padding(3);
			this.tabDisplaySettings.Size = new System.Drawing.Size(541, 615);
			...
			// 
			this.tabReportPermissions.Location = new System.Drawing.Point(2, 21);
			this.tabReportPermissions.Name = "tabReportPermissions";
			this.tabReportPermissions.Size = new System.Drawing.Size(541, 615);
			...
			this.tabReportServer.Location = new System.Drawing.Point(2, 21);
			this.tabReportServer.Name = "tabReportServer";
			this.tabReportServer.Padding = new System.Windows.Forms.Padding(3);
			this.tabReportServer.Size = new System.Drawing.Size(541, 615);
    ...
    "dle Tier database.";
			...
			// tabMiscOptions
			// 
			this.tabMiscOptions.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			this.tabMiscOptions.Controls.Add(this.checkUserQueryDefaultRaw);
			...
			this.tabMiscOptions.Location = new System.Drawing.Point(2, 21);
			this.tabMiscOptions.Name = "tabMiscOptions";
			this.tabMiscOptions.Padding = new System.Windows.Forms.Padding(3);
			this.tabMiscOptions.Size = new System.Drawing.Size(541, 615);
			this.tabMiscOptions.TabIndex = 0;
			this.tabMiscOptions.Text = "Misc Settings";
			// 
			// checkUserQueryDefaultRaw
			// 
			this.checkUserQueryDefaultRaw.Location = new System.Drawing.Point(20, 244);
			this.checkUserQueryDefaultRaw.Name = "checkUserQueryDefaultRaw";
			this.checkUserQueryDefaultRaw.Size = new System.Drawing.Size(511, 17);
			this.checkUserQueryDefaultRaw.TabIndex = 221;
			this.checkUserQueryDefaultRaw.Text = "Default to \'Raw\' format  in User Query window";
			// 
			// butIncompleteProcsExcludeCodes
			// 
			this.butIncompleteProcsExcludeCodes.Location = new System.Drawing.Point(501, 318);
			...
			this.textIncompleteProcsExcludeCodes.Location = new System.Drawing.Point(20, 319);
			...
			// comboReportWriteoff
			// 
			this.comboReportWriteoff.Location = new System.Drawing.Point(20, 279);
    ...
    "report";
		...
		private OpenDental.UI.CheckBox checkReportPrintWrapColumns;
    private OpenDental.UI.CheckBox checkReportPIClinicInfo;
		private OpenDental.UI.TabControl tabControl1;
		private OpenDental.UI.TabPage tabMiscOptions;
		private OpenDental.UI.TabPage tabDisplaySettings;
		private OpenDental.UI.CheckBox checkReportsShowHistory;
		private OpenDental.UI.CheckBox checkProviderPayrollAllowToday;
		private OpenDental.UI.CheckBox checkNetProdDetailUseSnapshotToday;
		private OpenDental.UI.CheckBox checkReportsIncompleteProcsUnsigned;
		private OpenDental.UI.CheckBox checkReportsIncompleteProcsNoNotes;
    private OpenDental.UI.TabPage tabReportServer;
    ...
    private OpenDental.UI.CheckBox checkUseReportServer;
		...
		private OpenDental.UI.CheckBox checkOutstandingRpDateTab;
		...
		private UI.CheckBox checkUserQueryDefaultRaw;
	}
}