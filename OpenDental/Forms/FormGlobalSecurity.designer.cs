namespace OpenDental{
	partial class FormGlobalSecurity {
		...
		private void InitializeComponent() {
			...
			this.checkDisableBackupReminder = new OpenDental.UI.CheckBox();
			...
			this.checkLogOffWindows = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkDisableBackupReminder;
		...
		private OpenDental.UI.CheckBox checkLogOffWindows;
