namespace OpenDental{
	partial class FormErxAccess {
		...
		private void InitializeComponent() {
			...
			this.butChangePatNum = new OpenDental.UI.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.butSave.Location = new System.Drawing.Point(383, 505);
			...
			// butChangePatNum
			// 
			this.butChangePatNum.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.butChangePatNum.Location = new System.Drawing.Point(12, 505);
			this.butChangePatNum.Name = "butChangePatNum";
			this.butChangePatNum.Size = new System.Drawing.Size(111, 24);
			this.butChangePatNum.TabIndex = 12;
			this.butChangePatNum.Text = "Change PatNum";
			this.butChangePatNum.Click += new System.EventHandler(this.butChangePatNum_Click);
			// 
			// FormErxAccess
			// 
			this.ClientSize = new System.Drawing.Size(470, 541);
			this.Controls.Add(this.butChangePatNum);
		...
		private UI.Button butChangePatNum;
	}
}