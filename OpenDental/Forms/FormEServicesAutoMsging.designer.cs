namespace OpenDental{
	partial class FormEServicesAutoMsging{
		...
		private void InitializeComponent() {
			...
			this.comboClinicEConfirm = new OpenDental.UI.ComboBox();
			this.checkIsConfirmEnabled = new OpenDental.UI.CheckBox();
			...
			this.checkUseDefaultNewPatTY = new OpenDental.UI.CheckBox();
			this.checkUseDefaultsInviteBefore = new OpenDental.UI.CheckBox();
			this.butAddNewPatThanks = new OpenDental.UI.Button();
			this.groupBox1 = new OpenDental.UI.GroupBox();
			this.butAddPatientPortalInviteBefore = new OpenDental.UI.Button();
			this.checkUseDefaultThanks = new OpenDental.UI.CheckBox();
			this.checkUseDefaultsConfirmation = new OpenDental.UI.CheckBox();
			this.checkUseDefaultsReminder = new OpenDental.UI.CheckBox();
			this.groupBox2 = new OpenDental.UI.GroupBox();
			this.checkUseDefaultsArrival = new OpenDental.UI.CheckBox();
			...
			// butActivateArrivals
			// 
			this.butActivateArrivals.Location = new System.Drawing.Point(164, 133);
			...
			// butActivateInvites
			// 
			this.butActivateInvites.Location = new System.Drawing.Point(164, 162);
			...
			this.checkUseDefaultNewPatTY.Name = "checkUseDefaultNewPatTY";
			this.checkUseDefaultNewPatTY.Size = new System.Drawing.Size(105, 19);
			this.checkUseDefaultNewPatTY.TabIndex = 517;
			this.checkUseDefaultNewPatTY.Text = "Use Defaults";
			this.checkUseDefaultNewPatTY.Click += new System.EventHandler(this.checkUseDefaultNewPatThanks_Click);
			// 
			// checkUseDefaultsInviteBefore
			// 
			this.checkUseDefaultsInviteBefore.Location = new System.Drawing.Point(6, 139);
			...
			// butAddNewPatThanks
			// 
			this.butAddNewPatThanks.Icon = OpenDental.UI.EnumIcons.Add;
			this.butAddNewPatThanks.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butAddNewPatThanks.Location = new System.Drawing.Point(156, 105);
			this.butAddNewPatThanks.Name = "butAddNewPatThanks";
			this.butAddNewPatThanks.Size = new System.Drawing.Size(185, 24);
			this.butAddNewPatThanks.TabIndex = 516;
			...
			this.butAddPatientPortalInviteBefore.Location = new System.Drawing.Point(156, 135);
			...
			this.groupBox4.Controls.Add(this.textStatusNewPatThanks);
			...
			this.groupBox4.Size = new System.Drawing.Size(347, 222);
			...
			// 
			this.butActivateGeneralMessages.Location = new System.Drawing.Point(164, 191);
		...
		private OpenDental.UI.ComboBox comboClinicEConfirm;
		private OpenDental.UI.CheckBox checkIsConfirmEnabled;
		...
		private OpenDental.UI.CheckBox checkUseDefaultThanks;
		private OpenDental.UI.CheckBox checkUseDefaultsConfirmation;
		private OpenDental.UI.CheckBox checkUseDefaultsReminder;
		private OpenDental.UI.CheckBox checkUseDefaultsArrival;
		private OpenDental.UI.CheckBox checkUseDefaultsInvite;
		...
		private OpenDental.UI.CheckBox checkUseDefaultsInviteBefore;
		private UI.Button butAddPatientPortalInviteBefore;
		private OpenDental.UI.CheckBox checkUseDefaultsGeneralMessage;
		private UI.Button butAddGeneralMessage;
		private OpenDental.UI.CheckBox checkUseDefaultNewPatTY;
