namespace OpenDental{
	partial class FormSheetFieldExam {
		...
		private void InitializeComponent() {
			...
			this.listBoxExamSheets = new OpenDental.UI.ListBox();
			this.label1 = new System.Windows.Forms.Label();
			this.butOK = new OpenDental.UI.Button();
			this.label10 = new System.Windows.Forms.Label();
			this.listBoxAvailFields = new OpenDental.UI.ListBox();
			this.SuspendLayout();
			// 
			// label2
			// 
			...
			this.listBoxExamSheets.Name = "listBoxExamSheets";
    ...
    "";
			...
			this.butOK.Location = new System.Drawing.Point(307, 376);
			...
			this.listBoxAvailFields.Name = "listBoxAvailFields";
		...
		private OpenDental.UI.ListBox listBoxExamSheets;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label10;
		private OpenDental.UI.ListBox listBoxAvailFields;
	}
}