...
namespace OpenDental{
	partial class FormPatientEdit {
		...
		private void InitializeComponent(){
			...
			this.comboGenderIdentity = new OpenDental.UI.ComboBox();
			this.comboSexOrientation = new OpenDental.UI.ComboBox();
			this.tabHospitals = new OpenDental.UI.TabPage();
			this.labelDischargeDate = new System.Windows.Forms.Label();
			this.odDatePickerDischargeDate = new OpenDental.UI.ODDatePicker();
			...
			this.checkDoseSpotConsent = new OpenDental.UI.CheckBox();
			...
			this.tabHospitals.Controls.Add(this.odDatePickerDischargeDate);
			...
			this.odDatePickerDischargeDate.TabIndex = 28;
			// 
			...
			this.tabEHR.Location = new System.Drawing.Point(2, 21);
			this.tabEHR.Name = "tabEHR";
			this.tabEHR.Padding = new System.Windows.Forms.Padding(3);
			this.tabEHR.Size = new System.Drawing.Size(461, 241);
		...
		private OpenDental.UI.TabPage tabEHR;
		...
		private OpenDental.UI.ComboBox comboGenderIdentity;
		private OpenDental.UI.ComboBox comboSexOrientation;
		...
		private UI.CheckBox checkDoseSpotConsent;
		...
		private UI.ODDatePicker odDatePickerDischargeDate;
