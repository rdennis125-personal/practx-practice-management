namespace OpenDental{
	partial class FormRpEraAutoProcessed {
		...
		private void InitializeComponent() {
			...
			this.checkShowAcknowledged = new OpenDental.UI.CheckBox();
			...
			this.listAutoProcessStatuses = new OpenDental.UI.ListBox();
		...
		private OpenDental.UI.CheckBox checkShowAcknowledged;
		...
		private UI.ListBox listAutoProcessStatuses;
