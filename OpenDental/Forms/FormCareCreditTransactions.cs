...
namespace OpenDental {
	public partial class FormCareCreditTransactions:FormODBase {
		...
		private void menuItemGoTo_Click(object sender,EventArgs e) {
			...
			GlobalFormOpenDental.GoToModule(EnumModuleType.Account,patNum:getGrid().SelectedTag<CareCreditWebResponse>().PatNum);
		}
		...
		private void AcknowledgeErrors() {
			...
			for(int i=0;i<listCareCreditWebResponses.Count;i++) {
				...
				bool isMerchantClosed=listCareCreditWebResponses[i].LastResponseStr.ToLower().Contains("merchant closed");
				if(isMerchantClosed) {
					countMerchantClosed++;
					continue;
				}
		...
		private void FillGridMain() {
			...
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Amount"),80,HorizontalAlignment.Right));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Date"),100));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Tran Type"),120));
			if(PrefC.HasClinicsEnabled) {
				gridMain.Columns.Add(new GridColumn(Lan.g(this,"Clinic"),120));
			}
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Ref ID"),110));
		...
		private void FillGridQSBatchTrans() {
			...
			gridQSBatchTrans.Columns.Clear();
			gridQSBatchTrans.Columns.Add(new GridColumn(Lan.g(this,"Date"),90,HorizontalAlignment.Right));
			gridQSBatchTrans.Columns.Add(new GridColumn(Lan.g(this,"Patient"),175));
			gridQSBatchTrans.Columns.Add(new GridColumn(Lan.g(this,"Date Processed"),90,HorizontalAlignment.Right));
			gridQSBatchTrans.Columns.Add(new GridColumn(Lan.g(this,"Status"),200));
			if(PrefC.HasClinicsEnabled) {
				gridQSBatchTrans.Columns.Add(new GridColumn(Lan.g(this,"Clinic"),120));
			}
			gridQSBatchTrans.Columns.Add(new GridColumn(Lan.g(this,"Ref ID"),70));
		...
		private void FillGridError() {
			...
			gridError.Columns.Clear();
			gridError.Columns.Add(new GridColumn(Lan.g(this,"Patient"),120));
			gridError.Columns.Add(new GridColumn(Lan.g(this,"Date"),80));
			if(checkIncludeAck.Checked) {
				gridError.Columns.Add(new GridColumn(Lan.g(this,"Date Ack"),80));
			}
			if(PrefC.HasClinicsEnabled) {
				gridError.Columns.Add(new GridColumn(Lan.g(this,"Clinic"),100));
			}
			gridError.Columns.Add(new GridColumn(Lan.g(this,"Status"),110));
			gridError.Columns.Add(new GridColumn(Lan.g(this,"Description"),170));
			gridError.Columns.Add(new GridColumn(Lan.g(this,"Parameter"),110));
			gridError.Columns.Add(new GridColumn(Lan.g(this,"Merchant Closed"),0,HorizontalAlignment.Center));
			...
			for(int i = 0;i<listCareCreditWebResponsesErrors.Count;++i) {
				...
				bool isMerchantClosed=listCareCreditWebResponsesErrors[i].LastResponseStr.ToLower().Contains("merchant closed");
				row.Cells.Add(isMerchantClosed ? "X" : "");
