namespace OpenDental {
	partial class FormReferralMerge {
		...
		private void InitializeComponent() {
			...
			this.checkIsDoctorFrom = new OpenDental.UI.CheckBox();
			this.butChangeReferralFrom = new OpenDental.UI.Button();
			this.checkIsPersonFrom = new OpenDental.UI.CheckBox();
			...
			this.checkIsDoctorInto = new OpenDental.UI.CheckBox();
			this.checkIsPersonInto = new OpenDental.UI.CheckBox();
			...
			// checkIsDoctorFrom
			// 
			this.checkIsDoctorFrom.CheckAlign = System.Drawing.ContentAlignment.MiddleLeft;
			...
			// checkIsPersonFrom
			// 
			this.checkIsPersonFrom.CheckAlign = System.Drawing.ContentAlignment.MiddleLeft;
			...
			// checkIsDoctorInto
			// 
			this.checkIsDoctorInto.CheckAlign = System.Drawing.ContentAlignment.MiddleLeft;
			...
			// checkIsPersonInto
			// 
			this.checkIsPersonInto.CheckAlign = System.Drawing.ContentAlignment.MiddleLeft;
		...
		private OpenDental.UI.CheckBox checkIsPersonInto;
		private OpenDental.UI.CheckBox checkIsDoctorFrom;
		private OpenDental.UI.CheckBox checkIsPersonFrom;
