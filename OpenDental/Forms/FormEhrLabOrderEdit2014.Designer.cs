namespace OpenDental {
	partial class FormEhrLabOrderEdit2014 {
		...
		private void InitializeComponent() {
			...
			this.checkAutoID = new OpenDental.UI.CheckBox();
			...
			this.checkResultsHandlingN = new OpenDental.UI.CheckBox();
			this.checkResultsHandlingF = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkResultsHandlingN;
		private OpenDental.UI.CheckBox checkResultsHandlingF;
		...
		private OpenDental.UI.CheckBox checkAutoID;
