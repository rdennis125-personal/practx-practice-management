namespace OpenDental{
	partial class FormCloudManagement {
		...
		private void InitializeComponent() {
			...
			this.groupSessionManagement = new OpenDental.UI.GroupBox();
			this.gridActiveInstances = new OpenDental.UI.GridOD();
			this.butChangePassword = new OpenDental.UI.Button();
			this.groupStorageManagement = new OpenDental.UI.GroupBox();
			...
			this.groupAllowedAddresses = new OpenDental.UI.GroupBox();
    ...
    "static IP address.";
		...
		private OpenDental.UI.GroupBox groupSessionManagement;
		private UI.Button butChangePassword;
		private OpenDental.UI.GroupBox groupStorageManagement;
		...
		private OpenDental.UI.GroupBox groupAllowedAddresses;
