namespace OpenDental {
	partial class FormRegistrationKeyEdit {
		...
		private void InitializeComponent() {
			...
			this.checkForeign = new OpenDental.UI.CheckBox();
			...
			this.checkFree = new OpenDental.UI.CheckBox();
			this.label9 = new System.Windows.Forms.Label();
			this.label10 = new System.Windows.Forms.Label();
			this.checkTesting = new OpenDental.UI.CheckBox();
			this.label11 = new System.Windows.Forms.Label();
			this.textVotesAllotted = new System.Windows.Forms.TextBox();
			this.label12 = new System.Windows.Forms.Label();
			this.label13 = new System.Windows.Forms.Label();
			this.checkResellerCustomer = new OpenDental.UI.CheckBox();
    ...
    "o Alpha version.";
		...
		private OpenDental.UI.CheckBox checkForeign;
