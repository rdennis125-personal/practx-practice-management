namespace OpenDental {
	partial class FormRequiredFields {
		...
		private void InitializeComponent() {
			...
			this.listAvailableFields = new OpenDental.UI.ListBox();
			this.labelExplanation = new System.Windows.Forms.Label();
			this.label1 = new System.Windows.Forms.Label();
			this.labelFieldType = new System.Windows.Forms.Label();
			this.label2 = new System.Windows.Forms.Label();
			this.checkMedicaidLength = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkMedicaidLength;
