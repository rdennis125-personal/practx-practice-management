namespace OpenDental {
	partial class FormProcEdit {
		...
		private void InitializeComponent() {
			...
			this.groupQuadrant = new OpenDental.UI.GroupBox();
			...
			this.groupArch = new OpenDental.UI.GroupBox();
			...
			this.groupSextant = new OpenDental.UI.GroupBox();
			...
			this.comboDrugUnit = new OpenDental.UI.ComboBox();
			...
			this.checkIsPrincDiag = new OpenDental.UI.CheckBox();
			...
			this.comboDx = new OpenDental.UI.ComboBox();
			this.comboProv = new OpenDental.UI.ComboBox();
			this.textUser = new System.Windows.Forms.TextBox();
			this.comboBillingTypeTwo = new OpenDental.UI.ComboBox();
			this.labelBillingTypeTwo = new System.Windows.Forms.Label();
			this.comboBillingTypeOne = new OpenDental.UI.ComboBox();
			...
			this.checkHideGraphics = new OpenDental.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.listProsth = new OpenDental.UI.ListBox();
			this.groupProsth = new OpenDental.UI.GroupBox();
			this.checkIsDateProsthEst = new OpenDental.UI.CheckBox();
			this.textDateOriginalProsth = new OpenDental.ValidDate();
			this.checkTypeCodeA = new OpenDental.UI.CheckBox();
			this.checkTypeCodeB = new OpenDental.UI.CheckBox();
			this.checkTypeCodeC = new OpenDental.UI.CheckBox();
			this.checkTypeCodeE = new OpenDental.UI.CheckBox();
			this.checkTypeCodeL = new OpenDental.UI.CheckBox();
			this.checkTypeCodeX = new OpenDental.UI.CheckBox();
			this.checkTypeCodeS = new OpenDental.UI.CheckBox();
			this.groupCanadianProcTypeCode = new OpenDental.UI.GroupBox();
			this.comboPrognosis = new OpenDental.UI.ComboBox();
			this.labelPrognosis = new System.Windows.Forms.Label();
			this.comboProcStatus = new OpenDental.UI.ComboBox();
			...
			this.tabPageFinancial = new OpenDental.UI.TabPage();
			...
			this.tabPageMedical = new OpenDental.UI.TabPage();
			...
			this.checkIcdVersion = new OpenDental.UI.CheckBox();
			...
			this.comboUnitType = new OpenDental.UI.ComboBox();
			this.tabPageMisc = new OpenDental.UI.TabPage();
			this.textBillingNote = new System.Windows.Forms.TextBox();
			this.label18 = new System.Windows.Forms.Label();
			this.butPickSite = new OpenDental.UI.Button();
			this.tabPageCanada = new OpenDental.UI.TabPage();
			...
			// groupQuadrant
			// 
			this.groupQuadrant.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			...
			// groupArch
			// 
			this.groupArch.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			...
			// groupSextant
			// 
			this.groupSextant.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
    ...
    "ou should reprint the claim if any significant changes are made.";
			...
			// groupProsth
			// 
			this.groupProsth.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			...
			// 
			this.groupCanadianProcTypeCode.BackColor = System.Drawing.Color.White;
			...
			this.signatureBoxWrapper.Location = new System.Drawing.Point(504, 325);
    ...
    " to edit.";
		...
		private OpenDental.UI.GroupBox groupQuadrant;
		...
		private OpenDental.UI.CheckBox checkIsPrincDiag;//ENP
		private System.Windows.Forms.Label label14;
		private System.Windows.Forms.Label label15;
		private System.Windows.Forms.Label label16;
		private UI.ComboBox comboProv;
		private OpenDental.UI.ComboBox comboDx;
		...
		private OpenDental.UI.ComboBox comboBillingTypeTwo;
		private System.Windows.Forms.Label labelBillingTypeTwo;
		private OpenDental.UI.ComboBox comboBillingTypeOne;
		...
		private OpenDental.UI.CheckBox checkHideGraphics;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label label4;
		private ValidDate textDateOriginalProsth;
		private OpenDental.UI.ListBox listProsth;
		private OpenDental.UI.GroupBox groupProsth;
		private OpenDental.UI.CheckBox checkTypeCodeA;
		private OpenDental.UI.CheckBox checkTypeCodeB;
		private OpenDental.UI.CheckBox checkTypeCodeC;
		private OpenDental.UI.CheckBox checkTypeCodeE;
		private OpenDental.UI.CheckBox checkTypeCodeL;
		private OpenDental.UI.CheckBox checkTypeCodeX;
		private OpenDental.UI.CheckBox checkTypeCodeS;
		private OpenDental.UI.GroupBox groupCanadianProcTypeCode;
		...
		private OpenDental.UI.ComboBox comboPrognosis;
		private System.Windows.Forms.Label labelPrognosis;
		private UI.ComboBox comboProcStatus;
		private OpenDental.UI.ComboBox comboDrugUnit;
		...
		private OpenDental.UI.TabPage tabPageFinancial;
		private OpenDental.UI.TabPage tabPageMedical;
		private OpenDental.UI.TabPage tabPageMisc;
		private OpenDental.UI.TabPage tabPageCanada;
		private System.Windows.Forms.Label labelUnitType;
		private OpenDental.UI.ComboBox comboUnitType;
		...
		private OpenDental.UI.CheckBox checkIsDateProsthEst;
		private OpenDental.UI.CheckBox checkIcdVersion;
		...
		private OpenDental.UI.CheckBox checkIsEmergency;
	}
}
