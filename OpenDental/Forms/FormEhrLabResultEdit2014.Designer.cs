namespace OpenDental {
	partial class FormEhrLabResultEdit2014 {
		...
		private void InitializeComponent() {
			...
			this.groupUnitsOfMeasure = new OpenDental.UI.GroupBox();
			...
			this.groupOrganization = new OpenDental.UI.GroupBox();
			...
			this.groupSN = new OpenDental.UI.GroupBox();
			...
			this.groupCE = new OpenDental.UI.GroupBox();
			...
			this.listAbnormalFlags = new OpenDental.UI.ListBox();
		...
		private OpenDental.UI.GroupBox groupUnitsOfMeasure;
		private OpenDental.UI.GroupBox groupOrganization;
		...
		private OpenDental.UI.GroupBox groupCE;
		...
		private OpenDental.UI.GroupBox groupSN;
		...
		private OpenDental.UI.ListBox listAbnormalFlags;
