...
namespace OpenDental {
	public partial class FormClearinghouseEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkAllowAttachSend = new OpenDental.UI.CheckBox();
			this.listBoxEraBehavior = new OpenDental.UI.ListBox();
			this.checkIsClaimExportAllowed = new OpenDental.UI.CheckBox();
