namespace OpenDental{
	partial class FormSmsTextMessaging {
		...
		private void InitializeComponent() {
			...
			this.checkRead = new OpenDental.UI.CheckBox();
			this.checkSent = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkSent;
		private OpenDental.UI.CheckBox checkRead;
