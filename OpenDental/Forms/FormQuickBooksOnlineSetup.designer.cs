namespace OpenDental{
	partial class FormQuickBooksOnlineSetup {
		...
		private void InitializeComponent() {
			...
			this.listBoxDepositAccountsInOD = new OpenDental.UI.ListBox();
			this.listBoxDepositAccountsAvailable = new OpenDental.UI.ListBox();
			this.listBoxIncomeAccountsInOD = new OpenDental.UI.ListBox();
			this.listBoxIncomeAccountsAvailable = new OpenDental.UI.ListBox();
			this.listBoxClassRefsInOD = new OpenDental.UI.ListBox();
			this.listBoxClassRefsAvailable = new OpenDental.UI.ListBox();
			...
			this.butSave.Location = new System.Drawing.Point(725, 573);
			...
			// groupEnable
			// 
			this.groupEnable.Controls.Add(this.textRealmID);
			this.groupEnable.Controls.Add(this.labelRealmID);
			...
			// textRealmID
			// 
			this.textRealmID.Location = new System.Drawing.Point(97, 86);
			this.textRealmID.Name = "textRealmID";
			this.textRealmID.ReadOnly = true;
			this.textRealmID.Size = new System.Drawing.Size(253, 20);
			this.textRealmID.TabIndex = 77;
			// 
			// labelRealmID
			// 
			this.labelRealmID.Location = new System.Drawing.Point(7, 85);
			this.labelRealmID.Name = "labelRealmID";
			this.labelRealmID.Size = new System.Drawing.Size(89, 20);
			this.labelRealmID.TabIndex = 79;
			this.labelRealmID.Text = "Realm ID";
			this.labelRealmID.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// textRefreshToken
			// 
    ...
    "de and Realm ID.";
		...
		private UI.ListBox listBoxDepositAccountsInOD;
		private UI.ListBox listBoxDepositAccountsAvailable;
		private UI.ListBox listBoxIncomeAccountsInOD;
		private UI.ListBox listBoxIncomeAccountsAvailable;
		private UI.ListBox listBoxClassRefsInOD;
		private UI.ListBox listBoxClassRefsAvailable;
	}
}