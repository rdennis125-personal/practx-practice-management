namespace OpenDental.User_Controls.SetupWizard {
	partial class UserControlSetupWizSchedule {
		...
		private void InitializeComponent() {
			...
			this.checkSaturday = new OpenDental.UI.CheckBox();
			this.labelProv = new System.Windows.Forms.Label();
			this.checkWednesday = new OpenDental.UI.CheckBox();
			this.checkThursday = new OpenDental.UI.CheckBox();
			this.checkFriday = new OpenDental.UI.CheckBox();
			this.checkTuesday = new OpenDental.UI.CheckBox();
			this.checkSunday = new OpenDental.UI.CheckBox();
			this.groupMon = new OpenDental.UI.GroupBox();
			this.gridMonday = new OpenDental.UI.GridOD();
			this.butAddMonday = new OpenDental.UI.Button();
			this.checkMonday = new OpenDental.UI.CheckBox();
			this.groupSun = new OpenDental.UI.GroupBox();
			this.gridSunday = new OpenDental.UI.GridOD();
			this.butAddSunday = new OpenDental.UI.Button();
			this.groupSat = new OpenDental.UI.GroupBox();
			this.gridSaturday = new OpenDental.UI.GridOD();
			this.butAddSaturday = new OpenDental.UI.Button();
			this.groupFri = new OpenDental.UI.GroupBox();
			this.gridFriday = new OpenDental.UI.GridOD();
			this.butAddFriday = new OpenDental.UI.Button();
			this.groupThu = new OpenDental.UI.GroupBox();
			this.gridThursday = new OpenDental.UI.GridOD();
			this.butAddThursday = new OpenDental.UI.Button();
			this.groupWed = new OpenDental.UI.GroupBox();
			this.gridWednesday = new OpenDental.UI.GridOD();
			this.butAddWednesday = new OpenDental.UI.Button();
			this.groupTue = new OpenDental.UI.GroupBox();
		...
		#endregion
		private OpenDental.UI.CheckBox checkSunday;
		private OpenDental.UI.CheckBox checkMonday;
		private OpenDental.UI.CheckBox checkTuesday;
		private OpenDental.UI.CheckBox checkFriday;
		private OpenDental.UI.CheckBox checkThursday;
		private OpenDental.UI.CheckBox checkWednesday;
		...
		private OpenDental.UI.CheckBox checkSaturday;
		private System.Windows.Forms.Label labelProv;
		private UI.Button butNextProv;
		private System.Windows.Forms.Label label2;
		private UI.Button butPrevProv;
		private OpenDental.UI.GroupBox groupMon;
		private OpenDental.UI.GroupBox groupTue;
		private OpenDental.UI.GroupBox groupWed;
		private OpenDental.UI.GroupBox groupThu;
		private OpenDental.UI.GroupBox groupFri;
		private OpenDental.UI.GroupBox groupSat;
		private OpenDental.UI.GroupBox groupSun;
	}
}
