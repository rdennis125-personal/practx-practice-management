namespace OpenDental {
	partial class UserControlReminderAgg {
		...
		private void InitializeComponent() {
			this.tabTemplates = new OpenDental.UI.TabControl();
			this.tabEmailTemplate = new OpenDental.UI.TabPage();
			...
			this.groupBoxEmailAggShared = new OpenDental.UI.GroupBox();
			...
			this.tabSMSTemplate = new OpenDental.UI.TabPage();
			...
			this.tabAutoReplyTemplate = new OpenDental.UI.TabPage();
			...
			this.tabArrivalTemplate = new OpenDental.UI.TabPage();
    ...
    "essage.";
			...
			this.tabSMSTemplate.Location = new System.Drawing.Point(2, 21);
			this.tabSMSTemplate.Name = "tabSMSTemplate";
			this.tabSMSTemplate.Padding = new System.Windows.Forms.Padding(3);
			this.tabSMSTemplate.Size = new System.Drawing.Size(631, 437);
    ...
    "essage.";
			...
			this.tabAutoReplyTemplate.Location = new System.Drawing.Point(2, 21);
			this.tabAutoReplyTemplate.Name = "tabAutoReplyTemplate";
			this.tabAutoReplyTemplate.Size = new System.Drawing.Size(631, 437);
			...
			this.tabArrivalTemplate.Location = new System.Drawing.Point(2, 21);
			this.tabArrivalTemplate.Name = "tabArrivalTemplate";
			this.tabArrivalTemplate.Size = new System.Drawing.Size(631, 437);
    ...
    " appointment.";
		...
		private OpenDental.UI.TabControl tabTemplates;
		private OpenDental.UI.TabPage tabEmailTemplate;
		private OpenDental.UI.GroupBox groupBoxEmailSubjAggShared;
		private System.Windows.Forms.Label labelEmailSubjAggShared;
		private ODtextBox textEmailSubjAggShared;
		private OpenDental.UI.GroupBox groupBoxEmailAggShared;
		...
		private OpenDental.UI.GroupBox groupBoxEmailAggPerAppt;
		private System.Windows.Forms.Label labelEmailAggPerAppt;
		private ODtextBox textEmailAggPerAppt;
		private OpenDental.UI.TabPage tabSMSTemplate;
		private OpenDental.UI.GroupBox groupBoxSMSAggPerAppt;
		private System.Windows.Forms.Label labelSMSAggPerAppt;
		private ODtextBox textSMSAggPerAppt;
		private OpenDental.UI.GroupBox groupBoxSMSAggShared;
		private System.Windows.Forms.Label labelSMSAggShared;
		private ODtextBox textSMSAggShared;
		private OpenDental.UI.TabPage tabAutoReplyTemplate;
		private OpenDental.UI.GroupBox groupAggregateAutoReplyTemplate;
		private System.Windows.Forms.Label labelAggregateAutoReply;
		private ODtextBox textAggregateAutoReply;
		private OpenDental.UI.GroupBox groupAutoReplySingle;
		private System.Windows.Forms.Label labelSingleAutoReply;
		private ODtextBox textSingleAutoReply;
		private OpenDental.UI.GroupBox groupBoxTags;
		private System.Windows.Forms.Label labelTags;
		private OpenDental.UI.TabPage tabArrivalTemplate;
		private OpenDental.UI.GroupBox groupArrivedReply;
		private System.Windows.Forms.Label label2;
		private ODtextBox textArrivalResponse;
		private OpenDental.UI.GroupBox groupComeIn;
