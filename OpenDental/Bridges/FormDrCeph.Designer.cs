...
namespace OpenDental {
	partial class FormDrCeph {
		...
		private void InitializeComponent() {
			...
			this.listBoxRace = new OpenDental.UI.ListBox();
			this.listBoxTxPhase = new OpenDental.UI.ListBox();
			this.SuspendLayout();
			// 
			// labelRace
			// 
		...
		private UI.ListBox listBoxRace;
		private UI.ListBox listBoxTxPhase;
	}
}