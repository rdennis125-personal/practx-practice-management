...
namespace OpenDental{
	partial class FormOpenDental {
		...
		private void LayoutMenuTools(MenuItemOD menuItemTools) {
			...
			//Web Chat Tools--------------------------------------------------------------------------------------------------
			_menuItemWebChatTools=new MenuItemOD("Chat Tools");
			...
			//Advertising-----------------------------------------------------------------------------------------------------
			MenuItemOD menuItemAdvertisingTools=new MenuItemOD("Advertising");
			menuItemTools.Add(menuItemAdvertisingTools);
			LayoutSubMenuAdvertising(menuItemAdvertisingTools);
			//Menus below have no submenus (name as shown)--------------------------------------------------------------------
		...
		private void LayoutSubMenuWebChatTools(MenuItemOD menuItemWebChatTools) {
			menuItemWebChatTools.Add("AI Chat", menuItemAiChatSessions_Click);
