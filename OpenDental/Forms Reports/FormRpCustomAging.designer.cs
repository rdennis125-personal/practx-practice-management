namespace OpenDental {
	partial class FormRpCustomAging {
		...
		private void InitializeComponent() {
			...
			this.checkExcludeBadAddresses = new OpenDental.UI.CheckBox();
			this.checkAllClin = new OpenDental.UI.CheckBox();
			this.checkAllProv = new OpenDental.UI.CheckBox();
			this.checkAllBillType = new OpenDental.UI.CheckBox();
			this.label3 = new System.Windows.Forms.Label();
			this.labelClinic = new System.Windows.Forms.Label();
			this.listBoxClins = new OpenDental.UI.ListBox();
			this.listBoxProvs = new OpenDental.UI.ListBox();
			this.listBoxBillTypes = new OpenDental.UI.ListBox();
			this.checkAgeCredits = new OpenDental.UI.CheckBox();
			...
			this.checkAgePatPayments = new OpenDental.UI.CheckBox();
			this.checkAgeWriteoffs = new OpenDental.UI.CheckBox();
			this.checkAgeInsPayments = new OpenDental.UI.CheckBox();
			this.checkAgeInsEsts = new OpenDental.UI.CheckBox();
			this.checkAgeAdjustments = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkExcludeBadAddresses;
		private OpenDental.UI.CheckBox checkAllClin;
		private OpenDental.UI.CheckBox checkAllProv;
		private OpenDental.UI.CheckBox checkAllBillType;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label labelClinic;
		private OpenDental.UI.ListBox listBoxClins;
		private OpenDental.UI.ListBox listBoxProvs;
		private OpenDental.UI.ListBox listBoxBillTypes;
		private OpenDental.UI.CheckBox checkAgeCredits;
		...
		private OpenDental.UI.CheckBox checkAgePatPayments;
		private OpenDental.UI.CheckBox checkAgeWriteoffs;
		private OpenDental.UI.CheckBox checkAgeInsPayments;
		private OpenDental.UI.CheckBox checkAgeInsEsts;
		private OpenDental.UI.CheckBox checkAgeAdjustments;
