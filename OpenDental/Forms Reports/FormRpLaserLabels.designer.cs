...
namespace OpenDental {
	public partial class FormRpLaserLabels {
		...
		private void InitializeComponent() {
			...
			this.tabCustomLabels = new OpenDental.UI.TabPage();
			this.butCusRemove = new OpenDental.UI.Button();
			this.butCusAdd = new OpenDental.UI.Button();
			this.listCusNames = new OpenDental.UI.ListBox();
			...
			this.tabInsCo = new OpenDental.UI.TabPage();
			...
			this.listProviders = new OpenDental.UI.ListBox();
			this.checkAllProviders = new OpenDental.UI.CheckBox();
			this.checkActiveOnly = new OpenDental.UI.CheckBox();
			this.checkGroupByFamily = new OpenDental.UI.CheckBox();
			...
			this.tabLabelSetup = new OpenDental.UI.TabControl();
			this.tabBirthday = new OpenDental.UI.TabPage();
			...
			this.tabCustomLabels.Location = new System.Drawing.Point(2, 21);
			this.tabCustomLabels.Name = "tabCustomLabels";
			this.tabCustomLabels.Padding = new System.Windows.Forms.Padding(3);
			this.tabCustomLabels.Size = new System.Drawing.Size(419, 322);
			...
			this.tabInsCo.Location = new System.Drawing.Point(2, 21);
			this.tabInsCo.Name = "tabInsCo";
			this.tabInsCo.Padding = new System.Windows.Forms.Padding(3);
			this.tabInsCo.Size = new System.Drawing.Size(419, 322);
			...
			this.tabPage1.Size = new System.Drawing.Size(419, 322);
			...
			this.labEndName.Location = new System.Drawing.Point(-95, 53);
			...
			this.tabBirthday.Location = new System.Drawing.Point(2, 21);
			this.tabBirthday.Name = "tabBirthday";
			this.tabBirthday.Padding = new System.Windows.Forms.Padding(3);
			this.tabBirthday.Size = new System.Drawing.Size(419, 322);
			...
			this.checkBirthdayActive.Location = new System.Drawing.Point(35, 122);
			this.checkBirthdayActive.Name = "checkBirthdayActive";
			this.checkBirthdayActive.Size = new System.Drawing.Size(176, 17);
			...
			this.panLabels.Location = new System.Drawing.Point(458, 72);
		...
		private OpenDental.UI.TabPage tabCustomLabels;
		private OpenDental.UI.TabPage tabInsCo;
		private OpenDental.UI.TabPage tabPage1;
		private OpenDental.UI.ListBox listProviders;
		private OpenDental.UI.CheckBox checkAllProviders;
		private OpenDental.UI.CheckBox checkActiveOnly;
		private OpenDental.UI.CheckBox checkGroupByFamily;
		...
		private OpenDental.UI.TabControl tabLabelSetup;
		...
		private OpenDental.UI.ListBox listCusNames;
		...
		private OpenDental.UI.TabPage tabBirthday;
		private Label labBirthdayTo;
		private Label labBirthdayFrom;
		private OpenDental.UI.CheckBox checkBirthdayActive;
