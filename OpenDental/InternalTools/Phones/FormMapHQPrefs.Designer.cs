namespace OpenDental{
	partial class FormMapHQPrefs {
		...
		private void InitializeComponent() {
			...
			this.groupRedTriage = new OpenDental.UI.GroupBox();
			this.textRedTime = new OpenDental.ValidNum();
			this.textRedCalls = new OpenDental.ValidNum();
			this.groupVoicemail = new OpenDental.UI.GroupBox();
			...
			this.groupTriage = new OpenDental.UI.GroupBox();
			...
			this.butSave.Location = new System.Drawing.Point(353, 266);
		...
		private OpenDental.UI.GroupBox groupRedTriage;
		private OpenDental.UI.GroupBox groupVoicemail;
		private System.Windows.Forms.Label labelVMTime;
		private System.Windows.Forms.Label labelVMCalls;
		private OpenDental.UI.GroupBox groupTriage;
