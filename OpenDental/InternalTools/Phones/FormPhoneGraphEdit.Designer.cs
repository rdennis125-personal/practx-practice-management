namespace OpenDental {
	partial class FormPhoneGraphEdit {
		...
		private void InitializeComponent() {
			...
			this.checkAbsent = new OpenDental.UI.CheckBox();
			this.label10 = new System.Windows.Forms.Label();
			this.textNote = new System.Windows.Forms.TextBox();
			this.butCopy = new OpenDental.UI.Button();
			this.butClear = new OpenDental.UI.Button();
			this.checkGraphDefault = new OpenDental.UI.CheckBox();
			this.checkPrescheduledOff = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkGraphDefault;
		private OpenDental.UI.CheckBox checkAbsent;
		private OpenDental.UI.CheckBox checkPrescheduledOff;
