	...
	partial class MapPanel
	{
		...
		protected override void Dispose(bool disposing)
		{
			if(disposing){
				...
				_bitmapPhone?.Dispose();
				_bitmapProxFig?.Dispose();
				_bitmapProxAway?.Dispose();
				_bitmapRemote?.Dispose();
			}
		...
		private void InitializeComponent()
		{
			...
			this.menuItemChanSpy = new System.Windows.Forms.ToolStripMenuItem();
			this.menuItemListenToCall = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.menuItemChanSpy,
            this.menuItemListenToCall});
			this.menuStatus.Name = "menuStatus";
			this.menuStatus.Size = new System.Drawing.Size(246, 606);
			// 
			...
			this.menuItemRinggroupAll.Click += new System.EventHandler(this.menuItemRinggroupTech_Click);
			// 
			...
			this.menuItemEmployeeSettings.Text = "Phone Emp Defaults";
			...
			// menuItemChanSpy
			// 
			this.menuItemChanSpy.Font = new System.Drawing.Font("Segoe UI", 9F, System.Drawing.FontStyle.Bold);
			this.menuItemChanSpy.Name = "menuItemChanSpy";
			this.menuItemChanSpy.Size = new System.Drawing.Size(245, 22);
			this.menuItemChanSpy.Text = "menuItemChanSpy";
			// 
			// menuItemListenToCall
			// 
			this.menuItemListenToCall.Name = "menuItemListenToCall";
			this.menuItemListenToCall.Size = new System.Drawing.Size(245, 22);
			this.menuItemListenToCall.Text = "Listen to Call";
			this.menuItemListenToCall.Click += new System.EventHandler(this.menuItemListenToCall_Click);
			// 
			// MapPanel
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem menuItemChanSpy;
		private System.Windows.Forms.ToolStripMenuItem menuItemListenToCall;
	}
}
