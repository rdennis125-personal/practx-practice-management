...
namespace OpenDental {
	public partial class FormPhoneEmpDefaultEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listRingGroup = new OpenDental.UI.ListBox();
			...
			this.listStatusOverride = new OpenDental.UI.ListBox();
			...
			this.textNotes.QuickPasteType = OpenDentBusiness.EnumQuickPasteType.PhoneEmpDefaultStatus;
    ...
    " to clock in and out.";
			...
			this.butDelete.Location = new System.Drawing.Point(27, 573);
			...
			this.butSave.Location = new System.Drawing.Point(644, 573);
    ...
    "e.  Used in MapHQ and reserving conference rooms.";
		...
		private OpenDental.UI.ListBox listRingGroup;
		...
		private OpenDental.UI.ListBox listStatusOverride;
