namespace OpenDental{
	partial class FormMapAreaContainerEdit {
		...
		private void InitializeComponent() {
			...
			this.butAddCubicle = new OpenDental.UI.Button();
			...
			// butAddCubicle
			// 
			this.butAddCubicle.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.butAddCubicle.Icon = OpenDental.UI.EnumIcons.Add;
			this.butAddCubicle.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butAddCubicle.Location = new System.Drawing.Point(1008, 346);
			this.butAddCubicle.Name = "butAddCubicle";
			this.butAddCubicle.Size = new System.Drawing.Size(93, 24);
			this.butAddCubicle.TabIndex = 120;
			this.butAddCubicle.Text = "Add Cubicle";
			this.butAddCubicle.Click += new System.EventHandler(this.butAddCubicle_Click);
			// 
			// butEdit
			// 
			...
			this.Controls.Add(this.butAddCubicle);
		...
		private UI.Button butAddCubicle;
