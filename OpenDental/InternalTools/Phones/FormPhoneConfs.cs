...
namespace OpenDental {
	public partial class FormPhoneConfs:FormODBase {
		...
		private void FillGrid() {
			...
			gridConfRoom.Columns.Add(new GridColumn("Extension",70,HorizontalAlignment.Center,GridSortingStrategy.AmountParse));
			gridConfRoom.Columns.Add(new GridColumn("MsgBtn",60,HorizontalAlignment.Center,GridSortingStrategy.AmountParse));
			gridConfRoom.Columns.Add(new GridColumn("Site",100));
			gridConfRoom.Columns.Add(new GridColumn("UserReserved",100));
			gridConfRoom.Columns.Add(new GridColumn("DateTimeReserved",110,HorizontalAlignment.Center,GridSortingStrategy.DateParse));
			gridConfRoom.Columns.Add(new GridColumn("Occupants",70,HorizontalAlignment.Center,GridSortingStrategy.AmountParse){ IsWidthDynamic=true });
