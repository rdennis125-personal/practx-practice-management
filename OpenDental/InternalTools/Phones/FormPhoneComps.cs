...
namespace OpenDental {
	public partial class FormPhoneComps:FormODBase {
		...
		private void FillMain() {
			...
			gridMain.Columns.Add(new GridColumn(Lan.g(gridMain.TranslationName,"Ext"),10,GridSortingStrategy.AmountParse){IsEditable=true,IsWidthDynamic=true,DynamicWeight=1});
			gridMain.Columns.Add(new GridColumn(Lan.g(gridMain.TranslationName,"CompName"),20,GridSortingStrategy.StringCompare){ IsWidthDynamic=true,DynamicWeight=2});
