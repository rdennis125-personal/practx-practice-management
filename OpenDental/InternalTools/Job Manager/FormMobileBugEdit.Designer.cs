namespace OpenDental {
	partial class FormMobileBugEdit {
		...
		private void InitializeComponent() {
			...
			this.checkiOS = new OpenDental.UI.CheckBox();
			this.checkAndroid = new OpenDental.UI.CheckBox();
			this.checkUWP = new OpenDental.UI.CheckBox();
			this.checkODMobile = new OpenDental.UI.CheckBox();
			this.checkEClipboard = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkiOS;
		private OpenDental.UI.CheckBox checkAndroid;
		private OpenDental.UI.CheckBox checkUWP;
		private OpenDental.UI.CheckBox checkODMobile;
		private OpenDental.UI.CheckBox checkEClipboard;
