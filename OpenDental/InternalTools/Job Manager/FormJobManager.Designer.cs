namespace OpenDental {
	partial class FormJobManager {
		...
		private void InitializeComponent() {
			...
			this.comboProposedVersionNeedsAction = new OpenDental.UI.ComboBox();
			this.checkShowUnassigned = new OpenDental.UI.CheckBox();
			this.gridAction = new OpenDental.UI.GridOD();
			this.tabSpecialProjects = new System.Windows.Forms.TabPage();
			this.checkShowUnassignedSpecial = new OpenDental.UI.CheckBox();
			...
			this.checkHideNotTested = new OpenDental.UI.CheckBox();
			this.butTestingRefresh = new OpenDental.UI.Button();
			this.checkShowAllUsers = new OpenDental.UI.CheckBox();
			this.checkHideTested = new OpenDental.UI.CheckBox();
			...
			this.comboProposedVersionNeedsEngineer = new OpenDental.UI.ComboBox();
			...
			this.comboProposedVersionNeedsExpert = new OpenDental.UI.ComboBox();
			...
			this.comboPrioritySearch = new OpenDental.UI.ComboBox();
			this.labelPrioritySearch = new System.Windows.Forms.Label();
			this.checkContactSearch = new OpenDental.UI.CheckBox();
			this.comboCatSearch = new OpenDental.UI.ComboBox();
			...
			this.checkShowDesignComplete = new OpenDental.UI.CheckBox();
			this.checkShowDesignCancelled = new OpenDental.UI.CheckBox();
			...
			this.checkIncludeCancelledUnresolved = new OpenDental.UI.CheckBox();
			this.tabSubmittedJobs = new System.Windows.Forms.TabPage();
			...
			// tabNeedsExpert
			// 
			this.tabNeedsExpert.Controls.Add(this.label2);
			...
			// 
			// checkShowOnHoldSubmitted
			// 
			this.checkShowOnHoldSubmitted.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkShowOnHoldSubmitted.Location = new System.Drawing.Point(187, 3);
			this.checkShowOnHoldSubmitted.Name = "checkShowOnHoldSubmitted";
			this.checkShowOnHoldSubmitted.Size = new System.Drawing.Size(159, 20);
			this.checkShowOnHoldSubmitted.TabIndex = 240;
			this.checkShowOnHoldSubmitted.Text = "Show OnHold";
			// 
			// gridSubmittedJobs
			// 
			this.gridSubmittedJobs.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.gridSubmittedJobs.HasMultilineHeaders = true;
		...
		private OpenDental.UI.CheckBox checkShowUnassigned;
		...
		private OpenDental.UI.CheckBox checkSubscribedIncludeOnHold;
		...
		private OpenDental.UI.CheckBox checkShowAllUsers;
		private OpenDental.UI.CheckBox checkHideTested;
		...
		private UI.ComboBox comboPrioritySearch;
		private System.Windows.Forms.Label labelPrioritySearch;
		private UI.ComboBox comboCatSearch;
		...
		private OpenDental.UI.CheckBox checkContactSearch;
		private System.Windows.Forms.TabPage tabSpecialProjects;
		private OpenDental.UI.CheckBox checkShowUnassignedSpecial;
		...
		private UI.ComboBox comboProposedVersionNeedsAction;
		private System.Windows.Forms.Label label7;
		private UI.ComboBox comboProposedVersionNeedsEngineer;
		private System.Windows.Forms.Label label8;
		private UI.ComboBox comboProposedVersionNeedsExpert;
		private System.Windows.Forms.Label labeluserSearch;
		private UI.ComboBox comboProposedVersionSearch;
		private OpenDental.UI.CheckBox checkHideNotTested;
		...
		private OpenDental.UI.CheckBox checkShowDesignComplete;
		private OpenDental.UI.CheckBox checkShowDesignCancelled;
		...
		private OpenDental.UI.CheckBox checkResults;
		...
		private OpenDental.UI.CheckBox checkIncludeCancelledUnresolved;
		private UI.Button butExport;
		private System.Windows.Forms.TabPage tabSubmittedJobs;
