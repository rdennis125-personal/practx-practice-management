namespace OpenDental{
	partial class FormReleaseCalculator {
		...
		private void InitializeComponent() {
			...
			this.listEngineers = new OpenDental.UI.ListBox();
			...
			this.listEngNoJobs = new OpenDental.UI.ListBox();
		...
		private UI.ListBox listEngineers;
		...
		private UI.ListBox listEngNoJobs;
