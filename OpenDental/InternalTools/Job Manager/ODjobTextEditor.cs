...
namespace OpenDental {
    ...
    private void ODjobTextEditor_Layout(object sender,LayoutEventArgs e) {
		...
		private void FillGridRequirements() {
			...
			gridRequirements.Columns.Add(new GridColumn("Concept Requirements List",100,!ReadOnlyRequirementsGrid){ IsWidthDynamic=true });
			gridRequirements.Columns.Add(new GridColumn("Expert",60,HorizontalAlignment.Center));
			gridRequirements.Columns.Add(new GridColumn("Engineer",60,HorizontalAlignment.Center));
			gridRequirements.Columns.Add(new GridColumn("Reviewer",60,HorizontalAlignment.Center));
			gridRequirements.Columns.Add(new GridColumn("",20,HorizontalAlignment.Center));
			gridRequirements.Columns.Add(new GridColumn("",20,HorizontalAlignment.Center));
		...
		private void butClearFormatting_Click(object sender,EventArgs e) {
			...
			try {
				_textFocused.SelectionFont=new Font("Microsoft Sans Serif",8.5f);
				_textFocused.SelectionBullet=false;
				_textFocused.SelectionColor=_textFocused.ForeColor;
				_textFocused.SelectionBackColor=_textFocused.BackColor;
				UpdateSelectedFontStyles(_textFocused);
