namespace OpenDental{
	partial class FormJobSearch {
		...
		private void InitializeComponent() {
			...
			this.listBoxUsers = new OpenDental.UI.ListBox();
			this.listBoxPhases = new OpenDental.UI.ListBox();
			this.listBoxCategory = new OpenDental.UI.ListBox();
			...
			this.listBoxPriorities = new OpenDental.UI.ListBox();
			this.SuspendLayout();
			// 
			// label2
			// 
		...
		private OpenDental.UI.ListBox listBoxUsers;
		private OpenDental.UI.ListBox listBoxPhases;
		private OpenDental.UI.ListBox listBoxCategory;
		...
		private UI.ListBox listBoxPriorities;
	}
}