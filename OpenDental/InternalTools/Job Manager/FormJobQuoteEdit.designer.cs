namespace OpenDental{
	partial class FormJobQuoteEdit {
		...
		private void InitializeComponent() {
			...
			this.checkIsApproved = new OpenDental.UI.CheckBox();
			...
			this.textQuoteHours.TabIndex = 1;
			// 
			// label3
			// 
			...
			this.textApprovedAmount.TabIndex = 3;
			// 
			// checkIsApproved
			// 
			...
			this.checkIsApproved.TabIndex = 5;
		...
		private OpenDental.UI.CheckBox checkIsApproved;
