namespace OpenDental {
	partial class ODjobTextEditor {
		...
		private void InitializeComponent() {
			...
			this.textConcept.QuickPasteType = OpenDentBusiness.EnumQuickPasteType.JobManager;
			...
			this.textWriteup.QuickPasteType = OpenDentBusiness.EnumQuickPasteType.JobManager;
