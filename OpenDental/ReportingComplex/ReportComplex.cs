...
namespace OpenDental.ReportingComplex {
	...
	public class ReportComplex {
		...
		public QueryObject AddQuery(DataTable table,string title,string columnNameToSplitOn,SplitByKind splitByKind,int queryGroup,bool isCentered) {
			QueryObject queryObj=new QueryObject(title,table,isCentered:isCentered,queryGroupValue:queryGroup,columnNameToSplitOn:columnNameToSplitOn,splitByKind:splitByKind);
			_reportObjects.Add(queryObj);
			return queryObj;
		}
