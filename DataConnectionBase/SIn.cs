...
namespace DataConnectionBase {
	...
	public class SIn{
		...
		///<summary>Processes dates incoming from db that look like "4/29/2013", and dates from textboxes where users entered and which have usually been validated. Returns MinValue if parsing error.</summary>
