...
namespace DataConnectionBase {
	...
	public class DbQueryObj {
		...
		///<summary>The name of the server that received the query</summary>
		public string ServerName;
		///<summary>Used to differentiate query objects from payload objects. True if payload object, false if query object.</summary>
		...
		public DbQueryObj(string command,string serverName) {
			GUID=Guid.NewGuid();
			Command=command;
