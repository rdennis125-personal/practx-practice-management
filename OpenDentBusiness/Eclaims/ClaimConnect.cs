	...
	public class XConnect {
		...
		public static string AttachmentCreate(Claim claim,string narrative) {
			...
			if(clinic==null) {
				...
				if(clinic.UseBillAddrOnClaims) {
					address1=clinic.BillingAddress;
					address2=clinic.BillingAddress2;
			...
			if(clinic==null) {//Clinics disabled or HQ
				xConnectAttachmentRenderingProvider.address1=PrefC.GetString(PrefName.PracticeAddress);
				xConnectAttachmentRenderingProvider.address2=PrefC.GetString(PrefName.PracticeAddress2);
				xConnectAttachmentRenderingProvider.city=PrefC.GetString(PrefName.PracticeCity);
				xConnectAttachmentRenderingProvider.state=PrefC.GetString(PrefName.PracticeST);
				xConnectAttachmentRenderingProvider.zipCode=PrefC.GetString(PrefName.PracticeZip);
			}
			else {//Clinics enabled
				xConnectAttachmentRenderingProvider.address1=clinic.Address;
				xConnectAttachmentRenderingProvider.address2=clinic.Address2;
