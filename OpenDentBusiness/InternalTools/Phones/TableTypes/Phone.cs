...
namespace OpenDentBusiness {
	...
	public class Phone:TableBase {
		...
		///<summary>Enum:AsteriskQueues  0=tech, 1=none, 2=backup, 3=triage.  This represents the active ring group for this extension.  This is different (and will often times differ) from the phoneempdefault.RingGroups which is just a default value for the extension.</summary>
