...
namespace OpenDentBusiness.WebTypes.WebSched.TimeSlot {
	public class TimeSlots {
		...
		{
			Meth.NoCheckMiddleTierRole();//This is a private method.
			...
			if(apptType!=null) {
				List<string> listProcCodesApptTypes=new List<string>(apptType.CodeStr.Split(','));
				...
				List<string> listProcCodesDB=Appointments.GetDoubleBookedCodes(apptTemp,dtAppts,procsMultApts,new Procedure[] { });
