...
namespace OpenDentBusiness.AutoComm {
	public class TagReplacer {
		...
		public static string GetPatternFromTag(string tag) {
			return tag.Replace("[","\\[")
				.Replace("(","\\(")
				.Replace(")","\\)");
		}
		...
		public virtual string ReplaceTags(string template,AutoCommObj autoCommObj,Clinic clinic,bool isEmailBody) {
		...
		public virtual string ReplaceTagsAggregate(string templateAll,string templateSingle,Clinic clinicCur,List<AutoCommObj> listAutoCommObjs,
