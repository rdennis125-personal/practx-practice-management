...
//Query each table using the dtstamp to get only new rows.
//This is multiple queries, but they usually return no rows.
//Should be very fast.
//None of the above possible improvements could be done until our overhaul is complete.
