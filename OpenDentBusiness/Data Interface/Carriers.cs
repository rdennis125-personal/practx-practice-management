...
namespace OpenDentBusiness{
	...
	public class Carriers{
		...
		public static void Combine(List<long> listCarrierNums,long pickedCarrierNum) {
			...
			List<InsPlan> listInsPlans=InsPlans.GetAllByCarrierNums(listCarrierNumsToCombine);
		...
		public static List<string> GetAllDistinctCarrierNames()	{
			...
			string command="SELECT DISTINCT CarrierName FROM carrier WHERE CarrierName!='' ORDER BY CarrierName ASC";
			List<string> listCarrierNames=Db.GetListString(command);
