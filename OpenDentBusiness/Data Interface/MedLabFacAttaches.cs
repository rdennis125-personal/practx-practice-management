	...
	public class MedLabFacAttaches{
		...
		*/
		...
		public static List<MedLabFacAttach> GetAllForResults(List<long> listMedLabResultNums) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetObject<List<MedLabFacAttach>>(MethodBase.GetCurrentMethod(),listMedLabResultNums);
			}
			string command="SELECT * FROM medlabfacattach WHERE MedLabResultNum IN("+String.Join(",",listMedLabResultNums)+")";
			return Crud.MedLabFacAttachCrud.SelectMany(command);
		}
		...
		public static void DeleteAllForLabsOrResults(List<long> listMedLabNums,List<long> listMedLabResultNums) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				Meth.GetVoid(MethodBase.GetCurrentMethod(),listMedLabNums,listMedLabResultNums);
				return;
			}
