	...
	public class AlertCategoryLinks{
		...
		private class AlertCategoryLinkCache : CacheListAbs<AlertCategoryLink> {
			...
			protected override void FillCacheIfNeeded() {
				AlertCategoryLinks.GetTableFromCache(doRefreshCache:false);
			}
		}
		...
		public static void ClearCache() {
			_alertCategoryLinkCache.ClearCache();
		}
		...
		public static bool Sync(List<AlertCategoryLink> listAlertCategoryLinksNew,List<AlertCategoryLink> listAlertCategoryLinksOld) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetBool(MethodBase.GetCurrentMethod(),listAlertCategoryLinksNew,listAlertCategoryLinksOld);
			}
			return Crud.AlertCategoryLinkCrud.Sync(listAlertCategoryLinksNew,listAlertCategoryLinksOld);
		}
		#endregion
	}
}