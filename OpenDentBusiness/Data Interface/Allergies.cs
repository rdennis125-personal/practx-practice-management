...
namespace OpenDentBusiness{
	...
	public class Allergies{
		...
		public static List<long> GetChangedSinceAllergyNums(DateTime dateTimeChangedSince) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetObject<List<long>>(MethodBase.GetCurrentMethod(),dateTimeChangedSince);
			}
			string command="SELECT AllergyNum FROM allergy WHERE DateTStamp > "+POut.DateT(dateTimeChangedSince);
		...
		public static List<Allergy> GetMultAllergies(List<long> allergyNums) {
			...
			List<Allergy> listAllergies=Crud.AllergyCrud.TableToList(table);
