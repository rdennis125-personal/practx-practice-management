...
namespace OpenDentBusiness{
	...
	public class JobTeams{
		...
		///<summary></summary>
		public static bool Sync(List<JobTeam> listJobTeams,List<JobTeam> listJobTeamsOld) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetBool(MethodBase.GetCurrentMethod(),listJobTeams,listJobTeamsOld);
			}
			return Crud.JobTeamCrud.Sync(listJobTeams,listJobTeamsOld);
		}
