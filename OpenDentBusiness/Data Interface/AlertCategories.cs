	...
	public class AlertCategories{
		...
		private class AlertCategoryCache : CacheListAbs<AlertCategory> {
			...
			protected override void FillCacheIfNeeded() {
				AlertCategories.GetTableFromCache(doRefreshCache:false);
			}
		}
		...
		public static void ClearCache() {
			_alertCategoryCache.ClearCache();
		}
		...
		public static bool Sync(List<AlertCategory> listAlertCategoriesNew,List<AlertCategory> listAlertCategoriesOld) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetBool(MethodBase.GetCurrentMethod(),listAlertCategoriesNew,listAlertCategoriesOld);
			}
			return Crud.AlertCategoryCrud.Sync(listAlertCategoriesNew,listAlertCategoriesOld);
		}
		#endregion
	}
}