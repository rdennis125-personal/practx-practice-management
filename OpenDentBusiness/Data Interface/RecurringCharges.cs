...
namespace OpenDentBusiness {
	...
	public class RecurringCharges{
		...
		public static bool HasRecurringChargesForPayment(long payNum) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetBool(MethodBase.GetCurrentMethod(),payNum);
			}
			string command="SELECT COUNT(*) FROM recurringcharge WHERE PayNum="+POut.Long(payNum);
