...
namespace OpenDentBusiness{
	...
	public class InsPlanPreferences{
		...
		public static InsPlanPreference GetOne(long fKey,InsPlanPrefFKeyType insPlanPrefFKeyType,long planNum){
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT){
				return Meth.GetObject<InsPlanPreference>(MethodBase.GetCurrentMethod(),fKey,insPlanPrefFKeyType,planNum);
			}
			string command=$@"SELECT * FROM insplanpreference 
				WHERE FKey={POut.Long(fKey)}
				AND FKeyType={POut.Int((int)insPlanPrefFKeyType)}
		...
		public static List<InsPlanPreference> GetManyForPlanNums(long fKey,InsPlanPrefFKeyType insPlanPrefFKeyType,List<long> listPlanNums){
			...
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetObject<List<InsPlanPreference>>(MethodBase.GetCurrentMethod(),fKey,insPlanPrefFKeyType,listPlanNums);
			}
			string command=$@"SELECT * FROM insplanpreference
				WHERE FKey={POut.Long(fKey)} 
				AND FKeyType={POut.Int((int)insPlanPrefFKeyType)} 
		...
		public static List<InsPlanPreference> GetManyForFKeys(List<long> listFKeys,InsPlanPrefFKeyType insPlanPrefFKeyType,InsPlan insPlan){
			...
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetObject<List<InsPlanPreference>>(MethodBase.GetCurrentMethod(),listFKeys,insPlanPrefFKeyType,insPlan);
			}
			string command=$@"SELECT * FROM insplanpreference 
		...
		public static void UpsertMany(long fKey,InsPlanPrefFKeyType insPlanPrefFKeyType,List<long> listPlanNums,string valueString){
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT){
				Meth.GetVoid(MethodBase.GetCurrentMethod(),fKey,insPlanPrefFKeyType,listPlanNums,valueString);
				return;
			}
			List<InsPlanPreference> listInsPlanPreferences=GetManyForPlanNums(fKey,insPlanPrefFKeyType,listPlanNums);
		...
		public static void DeleteMany(long fKey,InsPlanPrefFKeyType insPlanPrefFKeyType,List<long> listPlanNums) {
			...
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				Meth.GetVoid(MethodBase.GetCurrentMethod(),fKey,insPlanPrefFKeyType,listPlanNums);
				return;
			}
