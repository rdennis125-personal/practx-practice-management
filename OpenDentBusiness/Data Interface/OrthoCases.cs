...
namespace OpenDentBusiness{
	...
	public class OrthoCases{
		...
		{
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {//checked here to save time below
		...
		[Obsolete("This method is terrible and needs to be eliminated. We already eliminated one reference in FormProcEditAll, butOK_Click. The preferred strategy is to use local lists with about 3 calls directly to the database. This is a simple strategy that is heavily used throughout OD.")]
