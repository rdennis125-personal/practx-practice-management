...
namespace OpenDentBusiness {
	...
	public class EServiceShortGuids{
		...
		///<summary>Creates and Inserts an EServiceShortGuid using the passed in PatNum and ShortGuid. FKeyType=EServiceShortGuidKeyType.MsgToPayPatient, EServiceCode=eServiceCode.IntegratedTexting, DateTimeExpiration=Now + 7 days.</summary>
		public static void CreateAndInsertMsgToPayShortGuid(long patNum,string shortGuid) {
			Meth.NoCheckMiddleTierRole();
			EServiceShortGuid eServiceShortGuid=new EServiceShortGuid();
