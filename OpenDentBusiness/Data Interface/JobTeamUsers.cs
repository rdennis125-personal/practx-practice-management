...
namespace OpenDentBusiness{
	...
	public class JobTeamUsers{
		...
		///<summary></summary>
		public static bool Sync(List<JobTeamUser> listJobTeamUsers,List<JobTeamUser> listJobTeamUsersOld) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetBool(MethodBase.GetCurrentMethod(),listJobTeamUsers,listJobTeamUsersOld);
			}
			return Crud.JobTeamUserCrud.Sync(listJobTeamUsers,listJobTeamUsersOld);
		}
