...
namespace OpenDentBusiness {
	...
	public class Statements{
		...
		public static void AssignURLsIfNecessary(Statement statement,Patient patient) {
			...
			List<WebServiceMainHQProxy.ShortGuidResult> listShortGuidResultsUrls=WebServiceMainHQProxy.GetShortGUIDs(1,1,patient.ClinicNum,eServiceCode.PatientPortalViewStatement);
