	...
	public class Interventions{
		...
		*/
		...
		public static List<Intervention> Refresh(long patNum,InterventionCodeSet interventionCodeSet) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetObject<List<Intervention>>(MethodBase.GetCurrentMethod(),patNum,interventionCodeSet);
			}
			string command="SELECT * FROM intervention WHERE PatNum = "+POut.Long(patNum)+" AND CodeSet = "+POut.Int((int)interventionCodeSet);
			return Crud.InterventionCrud.SelectMany(command);
		}
		...
		public static List<string> GetAllForCodeSet(InterventionCodeSet interventionCodeSet) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetObject<List<string>>(MethodBase.GetCurrentMethod(),interventionCodeSet);
			}
			string command="SELECT CodeValue FROM intervention WHERE CodeSet="+POut.Int((int)interventionCodeSet)+" "
