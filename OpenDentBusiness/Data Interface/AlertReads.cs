...
namespace OpenDentBusiness{
	...
	public class AlertReads{
		...
		*/
		...
		public static bool Sync(List<AlertRead> listAlertReadsNew,List<AlertRead> listAlertReadsOld) {
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetBool(MethodBase.GetCurrentMethod(),listAlertReadsNew,listAlertReadsOld);
			}
			return Crud.AlertReadCrud.Sync(listAlertReadsNew,listAlertReadsOld);
		}
	}
}