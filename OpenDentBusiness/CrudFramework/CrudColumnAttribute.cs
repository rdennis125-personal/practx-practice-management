...
namespace OpenDentBusiness {
	...
	public class CrudColumnAttribute : Attribute {
		...
		/// <summary>Specifies the number of decimal places that this field will be rounded to when inserted into database. Use with CrudSpecialColType.Double.</summary>
