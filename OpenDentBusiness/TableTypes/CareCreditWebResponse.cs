...
namespace OpenDentBusiness {
	...
	public class CareCreditWebResponse:TableBase {
		...
		public DateTime GetDateTimeForProcessingStatus() {
			if(CareCreditWebResponses.ListWebStatusAcknowledge.Contains(ProcessingStatus) 
				|| CareCreditWebResponses.ListWebStatusCompleted.Contains(ProcessingStatus))
			{
				return DateTimeCompleted;
			}
			else if(CareCreditWebResponses.ListWebStatusError.Contains(ProcessingStatus)) {
				return DateTimeLastError;
			}
			else if(CareCreditWebResponses.ListWebStatusExpired.Contains(ProcessingStatus)) {
