...
namespace OpenDentBusiness{
	...
	public enum EnumPermType {
		...
		SecurityGlobal,
		[Description("Edit Read Only Tasks")]
		EditReadOnlyTasks,
		...
		ClinicEdit,
		///<summary>234 - Allows the editing of customer accounts for the ODApi via the BCM.</summary>
		[Description("Api Account Edit")]
		ApiAccountEdit,
		...
		SupplyPurchases,
		/// <summary>244 - Only used at OD HQ. Ability to edit table rows via Broadcast Monitor. </summary>
		[Description("Preference Edit Broadcast Monitor")]
		...
		CloudCustomerEdit,
		///<summary>251 - Only used at OD HQ. Ability to listen to live calls.</summary>
		[Description("Listen to Live Calls")]
		ChanSpy,
