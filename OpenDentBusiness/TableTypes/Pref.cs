...
namespace OpenDentBusiness {
	...
	public enum PrefName {
		...
		ApptConfirmExcludeGeneralMessage,
		...
		ApptConfirmExcludeNewPatThankYou,
		///<summary>Boolean.  Defaults to false. Only used for the clinicpref table, not the preference table. When true, this clinic will use the 
		...
		ApptNewPatientThankYouEnabled,
		///<summary>Boolean. Defaults to false. Only used for the clinicpref table, not the preference table. When true, this clinic will use the 
		///New Patient Thank You rules for ClinicNum 0.</summary>
		ApptNewPatientThankYouUseDefaults,
		...
		ApptNewPatientThankYouWebSheetDefID,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		ClaimMedReceivedPromptForPrimaryClaim,
		...
		CloudIsAppStream,
		///<summary>Deprecated for now. Hidden preference. The directory used for standard cloud client communication. If altered a restart is required as this value is set to a static variable on startup</summary>
		CloudFileWatcherDirectory,
		///<summary>Deprecated for now. Hidden preference. The directory used for API communication. If altered a restart is required as this value is set to a static variable on startup.</summary>
		...
		IncomeTransfersMadeUponClaimReceived,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		OrthoDebondProcCompletedSetsMonthsTreat,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		ProcNoteSigsBlockedAutoNoteIncomplete,
		...
		WebFormsDownloadAutomcatically,
		...
		WebSchedExistingPatAllowDisabledRecalls,
		...
		WebSchedExistingPatRequestInsurance,
		...
		WebSchedNewPatRequestInsurance,
