...
namespace OpenDentBusiness{
	...
	public enum InvalidType{
		...
		///Also used when sending a signal to the phone tracking server to kick users in conference rooms.  This will be used additionally to listen in on live calls.</summary>
		PhoneAsteriskReload,
		///<summary>51</summary>
		TimeCardRules,
		...
		AlertItems,
		///<summary>73. This is used internally by OD HQ, refreshes the voice mails.</summary>
		VoiceMails,
    ...
    EmailMessages,
		...
		PhoneComps,
		///<summary>87. Used internally by OD, refreshes call center map associated with tables MapArea and MapAreaContainer.</summary>
		PhoneMap,
		///<summary>88.</summary>
		SmsPhones,
