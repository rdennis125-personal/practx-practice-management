...
namespace OpenDentBusiness {
	...
	public interface IWebServiceMainHQ {
		...
		string EServiceLogUpload(string officeData);
		...
		string LicenseAgreementAccepted(string officeData);
		...
		string GetThinfinityLicenseUsers(string officeData);
		string GetMaxAtoZSizeGB(string officeData);
