...
namespace OpenDentBusiness {
	...
	public class XmlConverter {
		...
		/// <summary>This finds very specific kinds of string that looks like &#x10000;  Not sure why we can't escape them like any other xml char, but there must have been an issue at one point.  Returns a list of the invalid XML chars (both hex and char values that fall outside the valid char range for XML) contained in myString.</summary>
		public static List<string> XmlFindAllInvalidChars(string myString) {
			...
			//&#xD; =carriage return = &#13;
			//&#xA; =line feed = &#10;
			//There are essentailly 2 possibilities for invalid XML chars that we need to consider. The first is hex char values whose value
