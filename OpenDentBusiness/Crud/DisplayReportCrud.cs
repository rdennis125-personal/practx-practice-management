...
namespace OpenDentBusiness.Crud{
	public class DisplayReportCrud {
		...
		public static bool Sync(List<DisplayReport> listNew,List<DisplayReport> listDB) {
			...
			listNew.Sort((DisplayReport x,DisplayReport y) => { return x.DisplayReportNum.CompareTo(y.DisplayReportNum); });
			listDB.Sort((DisplayReport x,DisplayReport y) => { return x.DisplayReportNum.CompareTo(y.DisplayReportNum); });
			int idxNew=0;
			int idxDB=0;
