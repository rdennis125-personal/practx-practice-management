...
namespace OpenDentBusiness.Crud{
	public class JobPermissionCrud {
		...
		public static bool Sync(List<JobPermission> listNew,List<JobPermission> listDB) {
			...
			listNew.Sort((JobPermission x,JobPermission y) => { return x.JobPermissionNum.CompareTo(y.JobPermissionNum); });
			listDB.Sort((JobPermission x,JobPermission y) => { return x.JobPermissionNum.CompareTo(y.JobPermissionNum); });
			int idxNew=0;
			int idxDB=0;
