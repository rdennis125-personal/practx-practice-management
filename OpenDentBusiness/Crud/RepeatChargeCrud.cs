	...
	public class RepeatChargeCrud {
		...
		public static List<RepeatCharge> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				repeatCharge.Frequency      = (OpenDentBusiness.EnumRepeatChargeFrequency)PIn.Int(row["Frequency"].ToString());
		...
		public static DataTable ListToTable(List<RepeatCharge> listRepeatCharges,string tableName="") {
			...
			foreach(RepeatCharge repeatCharge in listRepeatCharges) {
				table.Rows.Add(new object[] {
					...
					POut.Double(repeatCharge.ChargeAmtAlt, decimalPlaces:4),
					            repeatCharge.UnearnedTypes,
					POut.Int   ((int)repeatCharge.Frequency),
				});
			}
			return table;
		}
		...
		public static void Update(RepeatCharge repeatCharge) {
			string command="UPDATE repeatcharge SET "
				...
				+"ChargeAmtAlt   =  "+POut.Double(repeatCharge.ChargeAmtAlt, decimalPlaces:4)+", "
				+"UnearnedTypes  = '"+POut.String(repeatCharge.UnearnedTypes)+"', "
				+"Frequency      =  "+POut.Int   ((int)repeatCharge.Frequency)+" "
		...
		public static bool Update(RepeatCharge repeatCharge,RepeatCharge oldRepeatCharge) {
			...
			if(repeatCharge.ChargeAmtAlt != oldRepeatCharge.ChargeAmtAlt) {
				if(command!="") { command+=",";}
				command+="ChargeAmtAlt = "+POut.Double(repeatCharge.ChargeAmtAlt, decimalPlaces:4)+"";
			}
			...
			if(repeatCharge.Frequency != oldRepeatCharge.Frequency) {
				if(command!="") { command+=",";}
				command+="Frequency = "+POut.Int   ((int)repeatCharge.Frequency)+"";
			}
			if(command=="") {
				return false;
			}
