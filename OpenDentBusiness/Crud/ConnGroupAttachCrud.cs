...
namespace OpenDentBusiness.Crud{
	public class ConnGroupAttachCrud {
		...
		public static bool Sync(List<ConnGroupAttach> listNew,List<ConnGroupAttach> listDB) {
			...
			listNew.Sort((ConnGroupAttach x,ConnGroupAttach y) => { return x.ConnGroupAttachNum.CompareTo(y.ConnGroupAttachNum); });
			listDB.Sort((ConnGroupAttach x,ConnGroupAttach y) => { return x.ConnGroupAttachNum.CompareTo(y.ConnGroupAttachNum); });
			int idxNew=0;
			int idxDB=0;
