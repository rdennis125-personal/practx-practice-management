...
namespace OpenDentBusiness.Crud{
	public class PatFieldDefCrud {
		...
		public static bool Sync(List<PatFieldDef> listNew,List<PatFieldDef> listDB) {
			...
			listNew.Sort((PatFieldDef x,PatFieldDef y) => { return x.PatFieldDefNum.CompareTo(y.PatFieldDefNum); });
			listDB.Sort((PatFieldDef x,PatFieldDef y) => { return x.PatFieldDefNum.CompareTo(y.PatFieldDefNum); });
			int idxNew=0;
			int idxDB=0;
