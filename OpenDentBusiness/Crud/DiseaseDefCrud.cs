...
namespace OpenDentBusiness.Crud{
	public class DiseaseDefCrud {
		...
		public static bool Sync(List<DiseaseDef> listNew,List<DiseaseDef> listDB) {
			...
			listNew.Sort((DiseaseDef x,DiseaseDef y) => { return x.DiseaseDefNum.CompareTo(y.DiseaseDefNum); });
			listDB.Sort((DiseaseDef x,DiseaseDef y) => { return x.DiseaseDefNum.CompareTo(y.DiseaseDefNum); });
			int idxNew=0;
			int idxDB=0;
