...
namespace OpenDentBusiness.Crud{
	public class UserOdPrefCrud {
		...
		public static bool Sync(List<UserOdPref> listNew,List<UserOdPref> listDB) {
			...
			listNew.Sort((UserOdPref x,UserOdPref y) => { return x.UserOdPrefNum.CompareTo(y.UserOdPrefNum); });
			listDB.Sort((UserOdPref x,UserOdPref y) => { return x.UserOdPrefNum.CompareTo(y.UserOdPrefNum); });
			int idxNew=0;
			int idxDB=0;
