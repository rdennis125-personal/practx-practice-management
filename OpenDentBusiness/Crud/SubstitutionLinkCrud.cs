...
namespace OpenDentBusiness.Crud{
	public class SubstitutionLinkCrud {
		...
		public static bool Sync(List<SubstitutionLink> listNew,List<SubstitutionLink> listDB) {
			...
			listNew.Sort((SubstitutionLink x,SubstitutionLink y) => { return x.SubstitutionLinkNum.CompareTo(y.SubstitutionLinkNum); });
			listDB.Sort((SubstitutionLink x,SubstitutionLink y) => { return x.SubstitutionLinkNum.CompareTo(y.SubstitutionLinkNum); });
			int idxNew=0;
			int idxDB=0;
