...
namespace OpenDentBusiness.Crud{
	public class ClaimTrackingCrud {
		...
		public static bool Sync(List<ClaimTracking> listNew,List<ClaimTracking> listDB) {
			...
			listNew.Sort((ClaimTracking x,ClaimTracking y) => { return x.ClaimTrackingNum.CompareTo(y.ClaimTrackingNum); });
			listDB.Sort((ClaimTracking x,ClaimTracking y) => { return x.ClaimTrackingNum.CompareTo(y.ClaimTrackingNum); });
			int idxNew=0;
			int idxDB=0;
