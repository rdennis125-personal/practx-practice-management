...
namespace OpenDentBusiness.Crud{
	public class SmsPhoneCrud {
		...
		public static bool Sync(List<SmsPhone> listNew,List<SmsPhone> listDB) {
			...
			listNew.Sort((SmsPhone x,SmsPhone y) => { return x.SmsPhoneNum.CompareTo(y.SmsPhoneNum); });
			listDB.Sort((SmsPhone x,SmsPhone y) => { return x.SmsPhoneNum.CompareTo(y.SmsPhoneNum); });
			int idxNew=0;
			int idxDB=0;
