...
namespace OpenDentBusiness.Crud{
	public class AlertReadCrud {
		...
		public static bool Sync(List<AlertRead> listNew,List<AlertRead> listDB) {
			...
			listNew.Sort((AlertRead x,AlertRead y) => { return x.AlertReadNum.CompareTo(y.AlertReadNum); });
			listDB.Sort((AlertRead x,AlertRead y) => { return x.AlertReadNum.CompareTo(y.AlertReadNum); });
			int idxNew=0;
			int idxDB=0;
