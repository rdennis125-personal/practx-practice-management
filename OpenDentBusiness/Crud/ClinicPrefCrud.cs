...
namespace OpenDentBusiness.Crud{
	public class ClinicPrefCrud {
		...
		public static bool Sync(List<ClinicPref> listNew,List<ClinicPref> listDB) {
			...
			listNew.Sort((ClinicPref x,ClinicPref y) => { return x.ClinicPrefNum.CompareTo(y.ClinicPrefNum); });
			listDB.Sort((ClinicPref x,ClinicPref y) => { return x.ClinicPrefNum.CompareTo(y.ClinicPrefNum); });
			int idxNew=0;
			int idxDB=0;
