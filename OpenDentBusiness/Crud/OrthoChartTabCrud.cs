...
namespace OpenDentBusiness.Crud{
	public class OrthoChartTabCrud {
		...
		public static bool Sync(List<OrthoChartTab> listNew,List<OrthoChartTab> listDB) {
			...
			listNew.Sort((OrthoChartTab x,OrthoChartTab y) => { return x.OrthoChartTabNum.CompareTo(y.OrthoChartTabNum); });
			listDB.Sort((OrthoChartTab x,OrthoChartTab y) => { return x.OrthoChartTabNum.CompareTo(y.OrthoChartTabNum); });
			int idxNew=0;
			int idxDB=0;
