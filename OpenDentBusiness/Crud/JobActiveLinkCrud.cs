...
namespace OpenDentBusiness.Crud{
	public class JobActiveLinkCrud {
		...
		public static bool Sync(List<JobActiveLink> listNew,List<JobActiveLink> listDB) {
			...
			listNew.Sort((JobActiveLink x,JobActiveLink y) => { return x.JobActiveLinkNum.CompareTo(y.JobActiveLinkNum); });
			listDB.Sort((JobActiveLink x,JobActiveLink y) => { return x.JobActiveLinkNum.CompareTo(y.JobActiveLinkNum); });
			int idxNew=0;
			int idxDB=0;
