...
namespace OpenDentBusiness.Crud{
	public class UserClinicCrud {
		...
		public static bool Sync(List<UserClinic> listNew,List<UserClinic> listDB) {
			...
			listNew.Sort((UserClinic x,UserClinic y) => { return x.UserClinicNum.CompareTo(y.UserClinicNum); });
			listDB.Sort((UserClinic x,UserClinic y) => { return x.UserClinicNum.CompareTo(y.UserClinicNum); });
			int idxNew=0;
			int idxDB=0;
