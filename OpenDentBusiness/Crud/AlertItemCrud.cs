	...
	public class AlertItemCrud {
		...
		public static List<AlertItem> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				alertItem.SecDateTEntry= PIn.DateT (row["SecDateTEntry"].ToString());
		...
		public static DataTable ListToTable(List<AlertItem> listAlertItems,string tableName="") {
			...
			foreach(AlertItem alertItem in listAlertItems) {
				table.Rows.Add(new object[] {
					...
					POut.DateT (alertItem.SecDateTEntry,false),
				});
			}
			return table;
		}
		...
		public static bool Sync(List<AlertItem> listNew,List<AlertItem> listDB) {
			...
			listNew.Sort((AlertItem x,AlertItem y) => { return x.AlertItemNum.CompareTo(y.AlertItemNum); });
			listDB.Sort((AlertItem x,AlertItem y) => { return x.AlertItemNum.CompareTo(y.AlertItemNum); });
			int idxNew=0;
			int idxDB=0;
