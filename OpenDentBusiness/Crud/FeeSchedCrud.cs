...
namespace OpenDentBusiness.Crud{
	public class FeeSchedCrud {
		...
		public static bool Sync(List<FeeSched> listNew,List<FeeSched> listDB,long userNum) {
			...
			listNew.Sort((FeeSched x,FeeSched y) => { return x.FeeSchedNum.CompareTo(y.FeeSchedNum); });
			listDB.Sort((FeeSched x,FeeSched y) => { return x.FeeSchedNum.CompareTo(y.FeeSchedNum); });
			int idxNew=0;
			int idxDB=0;
