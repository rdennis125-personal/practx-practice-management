...
namespace OpenDentBusiness.Crud{
	public class ProviderClinicCrud {
		...
		public static bool Sync(List<ProviderClinic> listNew,List<ProviderClinic> listDB) {
			...
			listNew.Sort((ProviderClinic x,ProviderClinic y) => { return x.ProviderClinicNum.CompareTo(y.ProviderClinicNum); });
			listDB.Sort((ProviderClinic x,ProviderClinic y) => { return x.ProviderClinicNum.CompareTo(y.ProviderClinicNum); });
			int idxNew=0;
			int idxDB=0;
