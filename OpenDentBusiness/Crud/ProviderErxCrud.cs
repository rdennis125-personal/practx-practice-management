...
namespace OpenDentBusiness.Crud{
	public class ProviderErxCrud {
		...
		public static bool Sync(List<ProviderErx> listNew,List<ProviderErx> listDB) {
			...
			listNew.Sort((ProviderErx x,ProviderErx y) => { return x.ProviderErxNum.CompareTo(y.ProviderErxNum); });
			listDB.Sort((ProviderErx x,ProviderErx y) => { return x.ProviderErxNum.CompareTo(y.ProviderErxNum); });
			int idxNew=0;
			int idxDB=0;
