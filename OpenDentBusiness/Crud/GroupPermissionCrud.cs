	...
	public class GroupPermissionCrud {
		...
		public static List<GroupPermission> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				groupPermission.PermType    = (OpenDentBusiness.EnumPermType)PIn.Int(row["PermType"].ToString());
		...
		public static bool Sync(List<GroupPermission> listNew,List<GroupPermission> listDB) {
			...
			listNew.Sort((GroupPermission x,GroupPermission y) => { return x.GroupPermNum.CompareTo(y.GroupPermNum); });
			listDB.Sort((GroupPermission x,GroupPermission y) => { return x.GroupPermNum.CompareTo(y.GroupPermNum); });
			int idxNew=0;
			int idxDB=0;
