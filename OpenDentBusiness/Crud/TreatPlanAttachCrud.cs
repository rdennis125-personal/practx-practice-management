...
namespace OpenDentBusiness.Crud{
	public class TreatPlanAttachCrud {
		...
		public static bool Sync(List<TreatPlanAttach> listNew,List<TreatPlanAttach> listDB) {
			...
			listNew.Sort((TreatPlanAttach x,TreatPlanAttach y) => { return x.TreatPlanAttachNum.CompareTo(y.TreatPlanAttachNum); });
			listDB.Sort((TreatPlanAttach x,TreatPlanAttach y) => { return x.TreatPlanAttachNum.CompareTo(y.TreatPlanAttachNum); });
			int idxNew=0;
			int idxDB=0;
