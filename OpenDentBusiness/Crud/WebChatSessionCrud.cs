	...
	public class WebChatSessionCrud {
		...
		public static List<WebChatSession> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				webChatSession.SessionType      = (OpenDentBusiness.WebChatSessionType)PIn.Int(row["SessionType"].ToString());
		...
		public static DataTable ListToTable(List<WebChatSession> listWebChatSessions,string tableName="") {
			...
			foreach(WebChatSession webChatSession in listWebChatSessions) {
				table.Rows.Add(new object[] {
					...
					POut.Int   ((int)webChatSession.SessionType),
				});
			}
			return table;
		}
		...
		public static long Insert(WebChatSession webChatSession,bool useExistingPK) {
			...
			command+="UserName,PracticeName,EmailAddress,PhoneNumber,IsCustomer,QuestionText,TechName,DateTcreated,DateTend,PatNum,IpAddress,SessionType) VALUES(";
			if(useExistingPK) {
		...
		public static void Update(WebChatSession webChatSession) {
			string command="UPDATE webchatsession SET "
				...
				+"SessionType      =  "+POut.Int   ((int)webChatSession.SessionType)+" "
		...
		public static bool Update(WebChatSession webChatSession,WebChatSession oldWebChatSession) {
			...
			if(webChatSession.SessionType != oldWebChatSession.SessionType) {
				if(command!="") { command+=",";}
				command+="SessionType = "+POut.Int   ((int)webChatSession.SessionType)+"";
			}
			if(command=="") {
				return false;
			}
