...
namespace OpenDentBusiness.Crud{
	public class AlertCategoryCrud {
		...
		public static bool Sync(List<AlertCategory> listNew,List<AlertCategory> listDB) {
			...
			listNew.Sort((AlertCategory x,AlertCategory y) => { return x.AlertCategoryNum.CompareTo(y.AlertCategoryNum); });
			listDB.Sort((AlertCategory x,AlertCategory y) => { return x.AlertCategoryNum.CompareTo(y.AlertCategoryNum); });
			int idxNew=0;
			int idxDB=0;
