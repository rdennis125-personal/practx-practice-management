...
namespace OpenDentBusiness.Crud{
	public class AlertCategoryLinkCrud {
		...
		public static bool Sync(List<AlertCategoryLink> listNew,List<AlertCategoryLink> listDB) {
			...
			listNew.Sort((AlertCategoryLink x,AlertCategoryLink y) => { return x.AlertCategoryLinkNum.CompareTo(y.AlertCategoryLinkNum); });
			listDB.Sort((AlertCategoryLink x,AlertCategoryLink y) => { return x.AlertCategoryLinkNum.CompareTo(y.AlertCategoryLinkNum); });
			int idxNew=0;
			int idxDB=0;
