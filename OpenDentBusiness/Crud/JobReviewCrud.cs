...
namespace OpenDentBusiness.Crud{
	public class JobReviewCrud {
		...
		public static bool Sync(List<JobReview> listNew,List<JobReview> listDB) {
			...
			listNew.Sort((JobReview x,JobReview y) => { return x.JobReviewNum.CompareTo(y.JobReviewNum); });
			listDB.Sort((JobReview x,JobReview y) => { return x.JobReviewNum.CompareTo(y.JobReviewNum); });
			int idxNew=0;
			int idxDB=0;
