	...
	public class AccountCrud {
		...
		public static List<Account> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				account.IsRetainedEarnings= PIn.Bool  (row["IsRetainedEarnings"].ToString());
				retVal.Add(account);
			}
			return retVal;
		}
		...
		public static DataTable ListToTable(List<Account> listAccounts,string tableName="") {
			...
			foreach(Account account in listAccounts) {
				table.Rows.Add(new object[] {
					...
					POut.Bool  (account.IsRetainedEarnings),
				});
			}
			return table;
		}
		...
		public static void Update(Account account) {
			string command="UPDATE account SET "
				...
				+"IsRetainedEarnings=  "+POut.Bool  (account.IsRetainedEarnings)+" "
		...
		public static bool Update(Account account,Account oldAccount) {
			...
			if(account.IsRetainedEarnings != oldAccount.IsRetainedEarnings) {
				if(command!="") { command+=",";}
				command+="IsRetainedEarnings = "+POut.Bool(account.IsRetainedEarnings)+"";
			}
			if(command=="") {
				return false;
			}
