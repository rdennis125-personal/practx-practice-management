...
namespace OpenDentBusiness.Crud{
	public class AlertSubCrud {
		...
		public static bool Sync(List<AlertSub> listNew,List<AlertSub> listDB) {
			...
			listNew.Sort((AlertSub x,AlertSub y) => { return x.AlertSubNum.CompareTo(y.AlertSubNum); });
			listDB.Sort((AlertSub x,AlertSub y) => { return x.AlertSubNum.CompareTo(y.AlertSubNum); });
			int idxNew=0;
			int idxDB=0;
