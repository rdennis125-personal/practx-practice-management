...
namespace OpenDentBusiness.Crud{
	public class JobTeamUserCrud {
		...
		public static bool Sync(List<JobTeamUser> listNew,List<JobTeamUser> listDB) {
			...
			listNew.Sort((JobTeamUser x,JobTeamUser y) => { return x.JobTeamUserNum.CompareTo(y.JobTeamUserNum); });
			listDB.Sort((JobTeamUser x,JobTeamUser y) => { return x.JobTeamUserNum.CompareTo(y.JobTeamUserNum); });
			int idxNew=0;
			int idxDB=0;
