	...
	public class InsPlanCrud {
		...
		public static List<InsPlan> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				insPlan.InsPlansZeroWriteOffsOnAnnualMaxOverride  = (OpenDentBusiness.YN)PIn.Int(row["InsPlansZeroWriteOffsOnAnnualMaxOverride"].ToString());
				insPlan.InsPlansZeroWriteOffsOnFreqOrAgingOverride= (OpenDentBusiness.YN)PIn.Int(row["InsPlansZeroWriteOffsOnFreqOrAgingOverride"].ToString());
				insPlan.PerVisitPatAmount                         = PIn.Double(row["PerVisitPatAmount"].ToString());
				insPlan.PerVisitInsAmount                         = PIn.Double(row["PerVisitInsAmount"].ToString());
				retVal.Add(insPlan);
			}
			return retVal;
		}
		...
		public static DataTable ListToTable(List<InsPlan> listInsPlans,string tableName="") {
			...
			foreach(InsPlan insPlan in listInsPlans) {
				table.Rows.Add(new object[] {
					...
					POut.Int   ((int)insPlan.InsPlansZeroWriteOffsOnAnnualMaxOverride),
					POut.Int   ((int)insPlan.InsPlansZeroWriteOffsOnFreqOrAgingOverride),
					POut.Double(insPlan.PerVisitPatAmount),
					POut.Double(insPlan.PerVisitInsAmount),
				});
			}
			return table;
		}
		...
		public static void Update(InsPlan insPlan) {
			string command="UPDATE insplan SET "
				...
				+"InsPlansZeroWriteOffsOnAnnualMaxOverride  =  "+POut.Int   ((int)insPlan.InsPlansZeroWriteOffsOnAnnualMaxOverride)+", "
				+"InsPlansZeroWriteOffsOnFreqOrAgingOverride=  "+POut.Int   ((int)insPlan.InsPlansZeroWriteOffsOnFreqOrAgingOverride)+", "
				+"PerVisitPatAmount                         =  "+POut.Double(insPlan.PerVisitPatAmount)+", "
				+"PerVisitInsAmount                         =  "+POut.Double(insPlan.PerVisitInsAmount)+" "
		...
		public static bool Update(InsPlan insPlan,InsPlan oldInsPlan) {
			...
			if(insPlan.InsPlansZeroWriteOffsOnAnnualMaxOverride != oldInsPlan.InsPlansZeroWriteOffsOnAnnualMaxOverride) {
				if(command!="") { command+=",";}
				command+="InsPlansZeroWriteOffsOnAnnualMaxOverride = "+POut.Int   ((int)insPlan.InsPlansZeroWriteOffsOnAnnualMaxOverride)+"";
			}
			if(insPlan.InsPlansZeroWriteOffsOnFreqOrAgingOverride != oldInsPlan.InsPlansZeroWriteOffsOnFreqOrAgingOverride) {
				if(command!="") { command+=",";}
				command+="InsPlansZeroWriteOffsOnFreqOrAgingOverride = "+POut.Int   ((int)insPlan.InsPlansZeroWriteOffsOnFreqOrAgingOverride)+"";
			}
			if(insPlan.PerVisitPatAmount != oldInsPlan.PerVisitPatAmount) {
				if(command!="") { command+=",";}
				command+="PerVisitPatAmount = "+POut.Double(insPlan.PerVisitPatAmount)+"";
			}
			if(insPlan.PerVisitInsAmount != oldInsPlan.PerVisitInsAmount) {
				if(command!="") { command+=",";}
				command+="PerVisitInsAmount = "+POut.Double(insPlan.PerVisitInsAmount)+"";
			}
			if(command=="") {
				return false;
			}
