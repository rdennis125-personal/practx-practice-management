...
namespace OpenDentBusiness.Crud{
	public class SigButDefCrud {
		...
		public static bool Sync(List<SigButDef> listNew,List<SigButDef> listDB) {
			...
			listNew.Sort((SigButDef x,SigButDef y) => { return x.SigButDefNum.CompareTo(y.SigButDefNum); });
			listDB.Sort((SigButDef x,SigButDef y) => { return x.SigButDefNum.CompareTo(y.SigButDefNum); });
			int idxNew=0;
			int idxDB=0;
