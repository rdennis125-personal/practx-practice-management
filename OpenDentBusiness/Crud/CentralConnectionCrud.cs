...
namespace OpenDentBusiness.Crud{
	public class CentralConnectionCrud {
		...
		public static bool Sync(List<CentralConnection> listNew,List<CentralConnection> listDB) {
			...
			listNew.Sort((CentralConnection x,CentralConnection y) => { return x.CentralConnectionNum.CompareTo(y.CentralConnectionNum); });
			listDB.Sort((CentralConnection x,CentralConnection y) => { return x.CentralConnectionNum.CompareTo(y.CentralConnectionNum); });
			int idxNew=0;
			int idxDB=0;
