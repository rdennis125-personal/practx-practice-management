	...
	public class SheetDefCrud {
		...
		public static List<SheetDef> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				sheetDef.AutoCheckSaveImage           = PIn.Bool  (row["AutoCheckSaveImage"].ToString());
				sheetDef.AutoCheckSaveImageDocCategory= PIn.Long  (row["AutoCheckSaveImageDocCategory"].ToString());
				retVal.Add(sheetDef);
			}
			return retVal;
		}
		...
		public static DataTable ListToTable(List<SheetDef> listSheetDefs,string tableName="") {
			...
			foreach(SheetDef sheetDef in listSheetDefs) {
				table.Rows.Add(new object[] {
					...
					POut.Bool  (sheetDef.AutoCheckSaveImage),
					POut.Long  (sheetDef.AutoCheckSaveImageDocCategory),
				});
			}
			return table;
		}
		...
		public static void Update(SheetDef sheetDef) {
			string command="UPDATE sheetdef SET "
				...
				+"AutoCheckSaveImage           =  "+POut.Bool  (sheetDef.AutoCheckSaveImage)+", "
				+"AutoCheckSaveImageDocCategory=  "+POut.Long  (sheetDef.AutoCheckSaveImageDocCategory)+" "
		...
		public static bool Update(SheetDef sheetDef,SheetDef oldSheetDef) {
			...
			if(sheetDef.AutoCheckSaveImage != oldSheetDef.AutoCheckSaveImage) {
				if(command!="") { command+=",";}
				command+="AutoCheckSaveImage = "+POut.Bool(sheetDef.AutoCheckSaveImage)+"";
			}
			if(sheetDef.AutoCheckSaveImageDocCategory != oldSheetDef.AutoCheckSaveImageDocCategory) {
				if(command!="") { command+=",";}
				command+="AutoCheckSaveImageDocCategory = "+POut.Long(sheetDef.AutoCheckSaveImageDocCategory)+"";
			}
			if(command=="") {
				return false;
			}
