...
namespace OpenDentBusiness.Crud{
	public class PayPlanChargeCrud {
		...
		public static bool Sync(List<PayPlanCharge> listNew,List<PayPlanCharge> listDB) {
			...
			listNew.Sort((PayPlanCharge x,PayPlanCharge y) => { return x.PayPlanChargeNum.CompareTo(y.PayPlanChargeNum); });
			listDB.Sort((PayPlanCharge x,PayPlanCharge y) => { return x.PayPlanChargeNum.CompareTo(y.PayPlanChargeNum); });
			int idxNew=0;
			int idxDB=0;
