...
namespace OpenDentBusiness.Crud{
	public class PhoneCompCrud {
		...
		public static bool Sync(List<PhoneComp> listNew,List<PhoneComp> listDB) {
			...
			listNew.Sort((PhoneComp x,PhoneComp y) => { return x.PhoneCompNum.CompareTo(y.PhoneCompNum); });
			listDB.Sort((PhoneComp x,PhoneComp y) => { return x.PhoneCompNum.CompareTo(y.PhoneCompNum); });
			int idxNew=0;
			int idxDB=0;
