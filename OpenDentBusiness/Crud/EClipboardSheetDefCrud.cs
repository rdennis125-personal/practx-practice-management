...
namespace OpenDentBusiness.Crud{
	public class EClipboardSheetDefCrud {
		...
		public static bool Sync(List<EClipboardSheetDef> listNew,List<EClipboardSheetDef> listDB) {
			...
			listNew.Sort((EClipboardSheetDef x,EClipboardSheetDef y) => { return x.EClipboardSheetDefNum.CompareTo(y.EClipboardSheetDefNum); });
			listDB.Sort((EClipboardSheetDef x,EClipboardSheetDef y) => { return x.EClipboardSheetDefNum.CompareTo(y.EClipboardSheetDefNum); });
			int idxNew=0;
			int idxDB=0;
