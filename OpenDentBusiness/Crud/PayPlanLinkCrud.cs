...
namespace OpenDentBusiness.Crud{
	public class PayPlanLinkCrud {
		...
		public static bool Sync(List<PayPlanLink> listNew,List<PayPlanLink> listDB) {
			...
			listNew.Sort((PayPlanLink x,PayPlanLink y) => { return x.PayPlanLinkNum.CompareTo(y.PayPlanLinkNum); });
			listDB.Sort((PayPlanLink x,PayPlanLink y) => { return x.PayPlanLinkNum.CompareTo(y.PayPlanLinkNum); });
			int idxNew=0;
			int idxDB=0;
