...
namespace OpenDentBusiness.Crud{
	public class ScreenPatCrud {
		...
		public static bool Sync(List<ScreenPat> listNew,List<ScreenPat> listDB) {
			...
			listNew.Sort((ScreenPat x,ScreenPat y) => { return x.ScreenPatNum.CompareTo(y.ScreenPatNum); });
			listDB.Sort((ScreenPat x,ScreenPat y) => { return x.ScreenPatNum.CompareTo(y.ScreenPatNum); });
			int idxNew=0;
			int idxDB=0;
