...
namespace OpenDentBusiness.Crud{
	public class PerioMeasureCrud {
		...
		public static bool Sync(List<PerioMeasure> listNew,List<PerioMeasure> listDB) {
			...
			listNew.Sort((PerioMeasure x,PerioMeasure y) => { return x.PerioMeasureNum.CompareTo(y.PerioMeasureNum); });
			listDB.Sort((PerioMeasure x,PerioMeasure y) => { return x.PerioMeasureNum.CompareTo(y.PerioMeasureNum); });
			int idxNew=0;
			int idxDB=0;
