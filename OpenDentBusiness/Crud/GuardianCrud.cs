...
namespace OpenDentBusiness.Crud{
	public class GuardianCrud {
		...
		public static bool Sync(List<Guardian> listNew,List<Guardian> listDB) {
			...
			listNew.Sort((Guardian x,Guardian y) => { return x.GuardianNum.CompareTo(y.GuardianNum); });
			listDB.Sort((Guardian x,Guardian y) => { return x.GuardianNum.CompareTo(y.GuardianNum); });
			int idxNew=0;
			int idxDB=0;
