...
namespace OpenDentBusiness.Crud{
	public class QuickPasteNoteCrud {
		...
		public static bool Sync(List<QuickPasteNote> listNew,List<QuickPasteNote> listDB) {
			...
			listNew.Sort((QuickPasteNote x,QuickPasteNote y) => { return x.QuickPasteNoteNum.CompareTo(y.QuickPasteNoteNum); });
			listDB.Sort((QuickPasteNote x,QuickPasteNote y) => { return x.QuickPasteNoteNum.CompareTo(y.QuickPasteNoteNum); });
			int idxNew=0;
			int idxDB=0;
