...
namespace OpenDentBusiness.Crud{
	public class StatementProdCrud {
		...
		public static bool Sync(List<StatementProd> listNew,List<StatementProd> listDB) {
			...
			listNew.Sort((StatementProd x,StatementProd y) => { return x.StatementProdNum.CompareTo(y.StatementProdNum); });
			listDB.Sort((StatementProd x,StatementProd y) => { return x.StatementProdNum.CompareTo(y.StatementProdNum); });
			int idxNew=0;
			int idxDB=0;
