...
namespace OpenDentBusiness.Crud{
	public class ProgramPropertyCrud {
		...
		public static bool Sync(List<ProgramProperty> listNew,List<ProgramProperty> listDB) {
			...
			listNew.Sort((ProgramProperty x,ProgramProperty y) => { return x.ProgramPropertyNum.CompareTo(y.ProgramPropertyNum); });
			listDB.Sort((ProgramProperty x,ProgramProperty y) => { return x.ProgramPropertyNum.CompareTo(y.ProgramPropertyNum); });
			int idxNew=0;
			int idxDB=0;
