...
namespace OpenDentBusiness.Crud{
	public class ProviderClinicLinkCrud {
		...
		public static bool Sync(List<ProviderClinicLink> listNew,List<ProviderClinicLink> listDB) {
			...
			listNew.Sort((ProviderClinicLink x,ProviderClinicLink y) => { return x.ProviderClinicLinkNum.CompareTo(y.ProviderClinicLinkNum); });
			listDB.Sort((ProviderClinicLink x,ProviderClinicLink y) => { return x.ProviderClinicLinkNum.CompareTo(y.ProviderClinicLinkNum); });
			int idxNew=0;
			int idxDB=0;
