...
namespace OpenDentBusiness.Crud{
	public class ProgramCrud {
		...
		public static long Insert(Program program,bool useExistingPK) {
			...
			OdSqlParameter paramPath=new OdSqlParameter("paramPath",OdDbType.Text,POut.StringParam(program.Path));
			if(program.CommandLine==null) {
				program.CommandLine="";
			}
			OdSqlParameter paramCommandLine=new OdSqlParameter("paramCommandLine",OdDbType.Text,POut.StringParam(program.CommandLine));
