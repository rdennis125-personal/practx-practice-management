...
namespace OpenDentBusiness.Crud{
	public class ConnectionGroupCrud {
		...
		public static bool Sync(List<ConnectionGroup> listNew,List<ConnectionGroup> listDB) {
			...
			listNew.Sort((ConnectionGroup x,ConnectionGroup y) => { return x.ConnectionGroupNum.CompareTo(y.ConnectionGroupNum); });
			listDB.Sort((ConnectionGroup x,ConnectionGroup y) => { return x.ConnectionGroupNum.CompareTo(y.ConnectionGroupNum); });
			int idxNew=0;
			int idxDB=0;
